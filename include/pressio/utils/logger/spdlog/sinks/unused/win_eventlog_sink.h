...
#ifndef PRESSIO_UTILS_LOGGER_SPDLOG_SINKS_UNUSED_WIN_EVENTLOG_SINK_H_
#define PRESSIO_UTILS_LOGGER_SPDLOG_SINKS_UNUSED_WIN_EVENTLOG_SINK_H_
...
#endif  // PRESSIO_UTILS_LOGGER_SPDLOG_SINKS_UNUSED_WIN_EVENTLOG_SINK_H_
