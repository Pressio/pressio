...
#ifndef QR_LOGGER_SPDLOG_SINKS_UNUSED_WIN_EVENTLOG_SINK_H_
#define QR_LOGGER_SPDLOG_SINKS_UNUSED_WIN_EVENTLOG_SINK_H_
...
#endif  // QR_LOGGER_SPDLOG_SINKS_UNUSED_WIN_EVENTLOG_SINK_H_
