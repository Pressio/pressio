...
#ifndef PRESSIO_UTILS_LOGGER_SPDLOG_PATTERN_FORMATTER_INL_HPP_
#define PRESSIO_UTILS_LOGGER_SPDLOG_PATTERN_FORMATTER_INL_HPP_
...
// Full info formatter
// original: [%Y-%m-%d %H:%M:%S.%e] [%n] [%l] %v
// FRizzi: [%Y-%m-%d %H:%M:%S.%e] [%l] %v
...
#endif  // PRESSIO_UTILS_LOGGER_SPDLOG_PATTERN_FORMATTER_INL_HPP_
