...
//     decltype(std::declval<FomMassMatrixOperatorType const>().createResultOfMassMatrixActionOn
...
//       fomMassMatAction_(fomMassMatOp.createResultOfMassMatrixActionOn(trialSubspace_.get().basisOfTranslatedSpace()))
//   {}
