...
struct qrGoldr9c4Sol{
  ...
  {
    EXPECT_NEAR(std::abs(trueYForRSolve_[0]), std::abs(y(0)), 1e-12 );
    EXPECT_NEAR(std::abs(trueYForRSolve_[1]), std::abs(y(1)), 1e-12 );
    EXPECT_NEAR(std::abs(trueYForRSolve_[2]), std::abs(y(2)), 1e-12 );
    EXPECT_NEAR(std::abs(trueYForRSolve_[3]), std::abs(y(3)), 1e-12 );
  }
