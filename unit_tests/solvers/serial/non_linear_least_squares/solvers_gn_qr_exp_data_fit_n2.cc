...
TEST(solvers_nonlinear_least_squares, gn_qr_exp_data_fit_n2){
  ...
  solvers::nonlinear::GaussNewtonQR<problem_t, qr_type> solver(problem, x);
...
TEST(solvers_nonlinear_least_squares, gn_qr_only_2_steps_exp_data_fit_n2){
  ...
  solvers::nonlinear::GaussNewtonQR<problem_t, qr_type, converged_when_t> solver(problem, x);
...
TEST(solvers_nonlinear_least_squares,
  ...
  using gnsolver_t	 =
    solvers::nonlinear::GaussNewtonQR<qr_type, converged_when_t, problem_t>;
