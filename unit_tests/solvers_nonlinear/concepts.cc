...
TEST(solvers_meta, admissible_linear_solver_newtonraphon)
{
  ...
  using namespace pressio;
  static_assert(nonlinearsolvers::constraints::linear_solver_for_newton_raphson<ValidLinearSolver, state_type>::value, "");
  static_assert(!nonlinearsolvers::constraints::linear_solver_for_newton_raphson<InvalidLinearSolver, state_type>::value, "");
}
...
TEST(solvers_meta, admissible_linear_solver_nonlinear_ls)
{
  using state_type    = std::vector<double>;
  using namespace pressio;
  static_assert(nonlinearsolvers::constraints::linear_solver_for_nonlinear_least_squares<ValidLinearSolver, state_type>::value, "");
  static_assert(!nonlinearsolvers::constraints::linear_solver_for_nonlinear_least_squares<InvalidLinearSolver, state_type>::value, "");
}
