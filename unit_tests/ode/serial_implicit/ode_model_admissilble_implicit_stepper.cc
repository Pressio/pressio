...
TEST(ode_implicit, checkModelsScalar){
  ...
  static_assert(!ode::meta::admissible_system_implicit_ode<app_t>::value, "");
  static_assert(!ode::meta::admissible_system_implicit_ode_regular_stepper<app_t>::value, "");
  static_assert(!ode::meta::admissible_system_implicit_ode_arbitrary_stepper<app_t>::value, "");
...
//   static_assert(ode::meta::admissible_system_implicit_ode_regular_stepper<app_t>::value, "");
//   static_assert(ode::meta::is_legitimate_model_for_implicit_ode_regular_stepper_with_user_defined_policies<app_t>::value, "");
...
//   using nstate_t = typename app_t::state_type;
//   using nvel_t   = typename app_t::velocity_type;
//   static_assert(ode::meta::is_legitimate_model_for_implicit_ode_regular_stepper<app_t>::value, "");
//   static_assert(ode::meta::is_legitimate_model_for_implicit_ode_regular_stepper_with_user_defined_policies<app_t>::value, "");
//   static_assert(!ode::meta::is_legitimate_model_for_implicit_ode_regular_stepper_with_standard_policies<app_t>::value, "");
...
//   static_assert(ode::meta::is_legitimate_model_for_implicit_ode_regular_stepper_with_standard_policies<app_t>::value, "");
//   static_assert(ode::meta::is_legitimate_model_for_implicit_ode_regular_stepper<app_t>::value, "");
//   static_assert(!ode::meta::is_legitimate_model_for_implicit_ode_arbitrary_stepper<app_t>::value, "");
// }
