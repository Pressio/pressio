...
TEST(ode_implicit, checkModelsScalar){
  ...
  static_assert(!ode::concepts::continuous_time_system_with_user_provided_jacobian<system_t>::value, "");
  static_assert(!ode::concepts::discrete_time_system_with_user_provided_jacobian<system_t>::value, "");
