...
int main(int argc, char *argv[])
{
  ...
  static_assert( ::pressio::containers::predicates::is_vector_kokkos<k1d_d>::value, "" );

  using k2d_d = Kokkos::View<double**, d_layout, exe_space>;
  using k2d_h = typename k2d_d::host_mirror_type;
  static_assert( ::pressio::containers::predicates::is_dense_matrix_kokkos<k2d_d>::value, "" );
