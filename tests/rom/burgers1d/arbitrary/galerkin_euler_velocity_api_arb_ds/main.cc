...
{
  using fom_t		= pressio::apps::Burgers1dArbDs;
  ...
  static_assert(pressio::rom::meta::is_legitimate_custom_ops_for_galerkin_velocity_api<
  ...
  EulerGalerkinWithVelocityApi()
  {
    ...
    using problem_t  = pressio::rom::galerkin::Problem<
      pressio::rom::galerkin::Default, ode_tag, fom_t, rom_state_t, decoder_t, ops_t>;
