...
// namespace{
// template <typename result_t, typename T = int>
// result_t readBasis(std::string filename, T romSize)
// {
...
struct EulerLSPGWithResidualApi
{
  ...
  EulerLSPGWithResidualApi()
  {
    ...
    native_dmat_t phiNative;
    decoder_jac_t phi(phiNative);// = readBasis("basis.txt", romSize, numCell);
