...
TEST(ode, implicit_bdf1_policy_default_created)
{
  ...
  auto stepperObj = ode::create_bdf1_stepper(problemObj, y);
...
TEST(ode, implicit_bdf1_policy_default_created_specify_types)
{
  using namespace pressio;
  using problem_t   = ode::testing::refAppForImpEigen;
  using state_t = typename problem_t::state_type;
  ...
  using jac_t = typename problem_t::jacobian_type;
  auto stepperObj = ode::create_bdf1_stepper_partial_deduction<res_t, jac_t>(problemObj, y);
...
TEST(ode, implicit_bdf1_custom_policy)
{
  ...
  auto stepperObj = ode::create_bdf1_stepper(problemObj, y, res_pol_t(), jac_pol_t());
...
TEST(ode, implicit_bdf1_custom_policy_specify_types)
{
  using namespace pressio;
  using problem_t = ode::testing::refAppForImpEigen;
  using state_t = typename problem_t::state_type;
  ...
  using res_pol_t = ode::impl::ResidualStandardPolicyBdf<state_t, res_t>;
  using jac_pol_t = ode::impl::JacobianStandardPolicyBdf<state_t, jac_t>;
  auto stepperObj = ode::create_bdf1_stepper_partial_deduction<res_t, jac_t>(problemObj, y, res_pol_t(), jac_pol_t());
