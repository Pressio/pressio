...
#define M5() const basis_matrix_type & viewBasis() const;
#define M6() const full_state_type & viewTranslation() const;
#define M7() int dimension() const;
#define M8() bool isColumnSpace() const;
#define M9() bool isRowSpace() const;

struct S1{
  NT1() NT2() NT3() M1() M2() M3() M4() M5() M7() M8() M9()
};

struct S2{
  NT1() NT2() NT3() NT4() M1() M2() M3() M4() M5() M6() M7() M8() M9()
};
