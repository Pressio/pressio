...
TEST(rom_lspg, cont_time_unsteady_hyperreduced_correctness_eigen)
{
...
TEST(rom_lspg, cont_time_unsteady_hyperreduced_correctness_custom_types)
{
  pressio::log::initialize(pressio::logto::terminal);
  pressio::log::setVerbosity({pressio::log::level::debug});
...
TEST(rom_lspg, disc_time_unsteady_hyperreduced_correctness_eigen)
{
  pressio::log::initialize(pressio::logto::terminal);
  pressio::log::setVerbosity({pressio::log::level::debug});
  ...
  auto problem = pressio::rom::lspg::create_hyperreduced_unsteady_problem<2>
