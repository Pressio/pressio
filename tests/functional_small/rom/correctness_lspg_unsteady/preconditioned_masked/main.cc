...
TEST(rom_lspg, cont_time_unsteady_prec_masked_correctness_eigen)
{
...
TEST(rom_lspg, cont_time_unsteady_prec_masked_correctness_custom_types)
{
  pressio::log::initialize(pressio::logto::terminal);
  pressio::log::setVerbosity({pressio::log::level::debug});
...
TEST(rom_lspg, disc_time_unsteady_prec_masked_correctness_eigen)
{
  pressio::log::initialize(pressio::logto::terminal);
  pressio::log::setVerbosity({pressio::log::level::debug});
  ...
  auto problem = pressio::rom::lspg::create_masked_unsteady_problem<2>
    (fomSystem, decoder, romState, fomReferenceState, masker, prec);
...
TEST(rom_lspg, disc_time_unsteady_prec_masked_correctness_custom_types)
{
  pressio::log::initialize(pressio::logto::terminal);
  pressio::log::setVerbosity({pressio::log::level::debug});
