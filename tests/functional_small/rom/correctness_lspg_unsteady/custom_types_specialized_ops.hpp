...
// this update is needed by the discrete-time residual
template<class ScalarType>
void update(pressiotests::MyCustomVector<ScalarType> & v,        const ScalarType a,
            const pressiotests::MyCustomVector<ScalarType> & v1, const ScalarType b,
	    const pressiotests::MyCustomVector<ScalarType> & v2, const ScalarType c)
{
  for (std::size_t i=0; i< v.extent(0); ++i){
...
void update(pressiotests::MyCustomVector<ScalarType> & v,        const ScalarType a,
            const pressiotests::MyCustomVector<ScalarType> & v1, const ScalarType b,
	    const pressiotests::MyCustomVector<ScalarType> & v2, const ScalarType c,
	    const pressiotests::MyCustomVector<ScalarType> & v3, const ScalarType d)
{
  for (std::size_t i=0; i< v.extent(0); ++i){
...
void update(pressiotests::MyCustomVector<ScalarType> & v,        const ScalarType a,
	    ...
	    const pressiotests::MyCustomVector<ScalarType> & v2, const ScalarType c,
	    const pressiotests::MyCustomVector<ScalarType> & v3, const ScalarType d,
	    const pressiotests::MyCustomVector<ScalarType> & v4, const ScalarType e)
{
  for (std::size_t i=0; i< v.extent(0); ++i){
...
// this update is needed by the discrete time jacobian
template<class ScalarType>
void update(pressiotests::MyCustomMatrix<ScalarType> & M,        const ScalarType a,
            const pressiotests::MyCustomMatrix<ScalarType> & M1, const ScalarType b)
{
