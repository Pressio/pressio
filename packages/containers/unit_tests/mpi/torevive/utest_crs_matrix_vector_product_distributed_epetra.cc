...
public:
  ...
  containers::Vector<Epetra_Vector> * b_;
  int nRowsSM_;
  Epetra_Map * smMap_;
  int nRowsV_;
  Epetra_Map * vMap_;
  ...
  virtual void SetUp() override{
    ...
    b_ = new containers::Vector<Epetra_Vector>(*vMap_);
  }
...
TEST_F(containers_matrix_vec_product_distributed_epetraFix, CRSMatTimesVector){
  //-----------
  // FILL A
  {
  ...
  // product: b = A b
  //------------------
  auto c = containers::mat_ops::product(*A_, *b_);
