...
public:
  ...
  containers::Matrix<Epetra_MultiVector> * A_;
  ...
  virtual void SetUp()
  {
    ...
    A_ = new containers::Matrix<Epetra_MultiVector>(*contigMapA_, nColsA);
    B_ = new containers::Matrix<Epetra_MultiVector>(*contigMapB_, nColsB);
  }
...
TEST_F(containers_matrix_dense_distributed_epetraFix, Test1)
{
  //-----------
  // FILL A
  // 9 x 6 matrix 
