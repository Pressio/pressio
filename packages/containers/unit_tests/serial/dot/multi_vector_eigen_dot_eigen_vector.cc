...
TEST(containers_multi_vector_serial_eigen_dynamic_class,
  ...
  // eigen vector
  rompp::containers::Vector<Eigen::VectorXd> b(6);
  b(0) = 1.; b(1) = 1.; b(2) = 1.;
  b(3) = 1.; b(4) = 2.; b(5) = 1.;
  
  auto c1 = rompp::containers::ops::dot(A,b);
  ...
  rompp::containers::Vector<Eigen::VectorXd> c(3);
  rompp::containers::ops::dot(A,b,c);
...
TEST(containers_multi_vector_serial_eigen_dynamic_class,
  ...
  eig_v_st a;
  rompp::containers::Vector<eig_v_st> c(a);
  rompp::containers::ops::dot(A,b,c);
  ASSERT_EQ(c.size(), 3);
