...
template<typename T>
struct containers_matrix_sparse_serial_eigen_classTest
  : public ::testing::Test{
public:
  using native_t = typename T::mat_t;
  using mymat_t = containers::Matrix<native_t>;
...
typedef ::testing::Types< typesEig<double,Eigen::RowMajor,int>, 
			  ...
			  > MyTypes;
TYPED_TEST_CASE(containers_matrix_sparse_serial_eigen_classTest, MyTypes);

TYPED_TEST(containers_matrix_sparse_serial_eigen_classTest, constructor){
  this->checkConstructor();
}

TYPED_TEST(containers_matrix_sparse_serial_eigen_classTest, filling){
  this->checkFilling();
}

TYPED_TEST(containers_matrix_sparse_serial_eigen_classTest, queryWrappedData){
  this->checkQuery();
}

TYPED_TEST(containers_matrix_sparse_serial_eigen_classTest, additionOperator){
  this->checkAdditionOperator();
}

TYPED_TEST(containers_matrix_sparse_serial_eigen_classTest, subtractionOperator){
  this->checkSubtractionOperator();
}

TYPED_TEST(containers_matrix_sparse_serial_eigen_classTest, starOperator){
  this->checkStarOperator();
}

TYPED_TEST(containers_matrix_sparse_serial_eigen_classTest, compoundAddOperator){
  this->checkCompoundAddOperator();
}

TYPED_TEST(containers_matrix_sparse_serial_eigen_classTest, compoundSubOperator){
  this->checkCompoundSubOperator();
}



// TEST(containers_matrix_sparse_serial_eigen_class, transpose)
// {
...
//   auto tm1 = containers::mat_ops::transpose(m4);
