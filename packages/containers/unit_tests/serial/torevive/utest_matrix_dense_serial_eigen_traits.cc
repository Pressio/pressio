...
template<typename T>
struct containers_matrix_dense_serial_eigen_traitsTest
  : public ::testing::Test{
public:
...
typedef ::testing::Types< typesEig<int,-1,-1>, typesEig<int,2,2>,
			  ...
			  > MyTypes;
TYPED_TEST_CASE(containers_matrix_dense_serial_eigen_traitsTest, MyTypes);

TYPED_TEST(containers_matrix_dense_serial_eigen_traitsTest, traits)
{
