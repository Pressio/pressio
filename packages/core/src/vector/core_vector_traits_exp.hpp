...
struct vector_traits {
  ...
  static constexpr VectorClass vector_class = VectorClass::Undefined;
...
> {
  typedef T wrapped_type;
  static constexpr VectorClass vector_class = VectorClass::Trilinos;
...
> {
  typedef T wrapped_type;
  static constexpr VectorClass vector_class = VectorClass::Eigen;
...
struct are_vector_compatible {
  static constexpr bool valid_vector = vector_traits<T>::vector_class != VectorClass::Undefined;
