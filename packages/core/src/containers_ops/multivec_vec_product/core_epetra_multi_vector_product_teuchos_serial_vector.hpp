...
#ifdef HAVE_TRILINOS
#ifndef CORE_CONTAINER_OPS_MVEC_VEC_PROD_EPETRA_MULTI_VECTOR_PRODUCT_TEUCHOS_SERIAL_VECTOR_HPP_
#define CORE_CONTAINER_OPS_MVEC_VEC_PROD_EPETRA_MULTI_VECTOR_PRODUCT_TEUCHOS_SERIAL_VECTOR_HPP_
