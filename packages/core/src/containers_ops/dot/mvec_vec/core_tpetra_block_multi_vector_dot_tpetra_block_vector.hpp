...
#ifdef HAVE_TRILINOS
#ifndef CORE_TPETRA_BLOCK_MULTI_VECTOR_TPETRA_BLOCK_VECTOR_HPP_
#define CORE_TPETRA_BLOCK_MULTI_VECTOR_TPETRA_BLOCK_VECTOR_HPP_
...
template <typename mvec_type,
  ...
  ::rompp::mpl::enable_if_t<
    core::meta::is_multi_vector_wrapper_tpetra_block<mvec_type>::value &&
...
template <typename mvec_type,
  ...
  ::rompp::mpl::enable_if_t<
    core::meta::is_multi_vector_wrapper_tpetra_block<mvec_type>::value and
    core::meta::is_vector_wrapper_tpetra_block<vec_type>::value and
