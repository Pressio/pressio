...
#ifndef ALGEBRA_MATRIX_CONCRETE_MATRIX_DENSE_SHAREDMEM_EIGEN_STATIC_HPP_
#define ALGEBRA_MATRIX_CONCRETE_MATRIX_DENSE_SHAREDMEM_EIGEN_STATIC_HPP_
...
class Matrix<wrapped_type,
	     ::rompp::mpl::enable_if_t<
	       algebra::meta::is_dense_static_matrix_eigen<
		 wrapped_type>::value>
	     >
