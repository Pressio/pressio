...
#ifdef HAVE_TRILINOS
#ifndef ALGEBRA_MATRIX_CONCRETE_MATRIX_SPARSE_DISTRIBUTED_TPETRA_HPP_
#define ALGEBRA_MATRIX_CONCRETE_MATRIX_SPARSE_DISTRIBUTED_TPETRA_HPP_
...
class Matrix<wrapped_type,
	     ::rompp::mpl::enable_if_t<
	       algebra::meta::is_sparse_matrix_tpetra<
		 wrapped_type>::value>
	     >
