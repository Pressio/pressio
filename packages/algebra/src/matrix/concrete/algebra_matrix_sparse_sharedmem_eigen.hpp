...
#ifndef ALGEBRA_MATRIX_CONCRETE_MATRIX_SPARSE_SHAREDMEM_EIGEN_HPP_
#define ALGEBRA_MATRIX_CONCRETE_MATRIX_SPARSE_SHAREDMEM_EIGEN_HPP_
...
#include "../base/algebra_matrix_sparse_sharedmem_base.hpp"
