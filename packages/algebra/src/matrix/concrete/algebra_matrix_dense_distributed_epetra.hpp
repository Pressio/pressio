...
#ifdef HAVE_TRILINOS
#ifndef ALGEBRA_MATRIX_CONCRETE_MATRIX_DENSE_DISTRIBUTED_EPETRA_HPP_
#define ALGEBRA_MATRIX_CONCRETE_MATRIX_DENSE_DISTRIBUTED_EPETRA_HPP_
...
#include "../base/algebra_matrix_dense_distributed_base.hpp"
