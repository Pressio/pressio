...
#ifdef HAVE_TRILINOS
#ifndef ALGEBRA_IS_SPARSE_MATRIX_WRAPPER_EPETRA_HPP_
#define ALGEBRA_IS_SPARSE_MATRIX_WRAPPER_EPETRA_HPP_
...
struct is_sparse_matrix_wrapper_epetra<
  T, ::rompp::mpl::enable_if_t<
	...
	algebra::details::WrappedMatrixIdentifier::CrsEpetra)
       >
  >
  : std::true_type{};
