...
struct traits<
  Matrix<
    wrapped_type,
    mpl::enable_if_t<
      !algebra::meta::is_dense_matrix_eigen<wrapped_type>::value and
      !algebra::meta::is_sparse_matrix_eigen<wrapped_type>::value
    #ifdef HAVE_TRILINOS
      and 
      !algebra::meta::is_sparse_matrix_epetra<wrapped_type>::value and
      !algebra::meta::is_dense_matrix_epetra<wrapped_type>::value and
      !algebra::meta::is_dense_matrix_teuchos<wrapped_type>::value and
      !algebra::meta::is_dense_matrix_teuchos_rcp<wrapped_type>::value and
      !algebra::meta::is_sparse_matrix_tpetra<wrapped_type>::value
    #endif
      >
    >
  > {
...
struct traits< Matrix<
    ...
    typename
    std::enable_if<
      algebra::meta::is_dense_matrix_eigen<
	wrapped_type>::value
      >::type
    >
  >
...
struct traits< Matrix<
    ...
    typename
    std::enable_if<
      algebra::meta::is_sparse_matrix_eigen<
	wrapped_type
	>::value
      >::type
    >
...
struct traits<Matrix<wrapped_type,
	  typename
	  std::enable_if<
	    algebra::meta::is_dense_matrix_teuchos<
	      wrapped_type>::value
	    >::type
	  >
	>
...
struct traits<Matrix
   <wrapped_type,
    typename
    std::enable_if<
      algebra::meta::is_dense_matrix_epetra<
	wrapped_type
	>::value
      >::type
    >
