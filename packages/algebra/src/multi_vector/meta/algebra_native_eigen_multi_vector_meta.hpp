...
#ifndef ALGEBRA_NATIVE_EIGEN_MULTIVECTOR_META_HPP_
#define ALGEBRA_NATIVE_EIGEN_MULTIVECTOR_META_HPP_

#include "../../meta/algebra_meta_basic.hpp"
#include "../../matrix/meta/algebra_native_eigen_matrix_meta.hpp"
