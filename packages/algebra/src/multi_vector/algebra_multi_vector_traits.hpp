...
struct traits<
  MultiVector<
    wrapped_type,
    mpl::enable_if_t<
      !algebra::meta::is_dynamic_multi_vector_eigen<wrapped_type>::value and
      !algebra::meta::is_multi_vector_epetra<wrapped_type>::value and
      !algebra::meta::is_multi_vector_tpetra_block<wrapped_type>::value and
      !algebra::meta::is_multi_vector_tpetra<wrapped_type>::value
      >
    >
  > {
