...
#ifndef ALGEBRA_EIGEN_OPS_HELPER_IMPL_HPP_
#define ALGEBRA_EIGEN_OPS_HELPER_IMPL_HPP_

#include "algebra_ops_meta.hpp"
#include "../matrix/algebra_matrix_meta.hpp"

namespace rompp{ namespace algebra{ namespace ops{ namespace impl{
...
struct eigenMatMatProdRetTypeHelper<
  ...
  ::rompp::mpl::enable_if_t<
    algebra::meta::is_dense_matrix_wrapper_eigen<TA>::value
    >
  >{
  using prod_type = TA;
};
...
struct eigenMatMatProdRetTypeHelper<
  TA, TA,
  ::rompp::mpl::enable_if_t<
    algebra::meta::is_sparse_matrix_wrapper_eigen<TA>::value
    >
  >{
  using prod_type = TA;
};
...
struct eigenMatMatProdRetTypeHelper<
  TA, TB,
  ::rompp::mpl::enable_if_t<
    algebra::meta::is_sparse_matrix_wrapper_eigen<TA>::value and
    algebra::meta::is_dense_matrix_wrapper_eigen<TB>::value
    >
  >{
  using prod_type = TB;
};
...
struct eigenMatMatProdRetTypeHelper<
  TA, TB,
  ::rompp::mpl::enable_if_t<
    algebra::meta::is_dense_matrix_wrapper_eigen<TA>::value and
    algebra::meta::is_sparse_matrix_wrapper_eigen<TB>::value
    >
  >{
  using prod_type = TA;
};
...
}}}}//end namespace rompp::algebra::ops::impl
#endif
