...
#ifdef HAVE_TRILINOS
#ifndef ALGEBRA_CONTAINER_OPS_MVEC_VEC_PROD_EPETRA_MULTI_VECTOR_PRODUCT_EIGEN_VECTOR_HPP_
#define ALGEBRA_CONTAINER_OPS_MVEC_VEC_PROD_EPETRA_MULTI_VECTOR_PRODUCT_EIGEN_VECTOR_HPP_
