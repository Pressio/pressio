...
#ifdef HAVE_TRILINOS
#ifndef ALGEBRA_TPETRA_MULTI_VECTOR_TPETRA_VECTOR_HPP_
#define ALGEBRA_TPETRA_MULTI_VECTOR_TPETRA_VECTOR_HPP_
...
template <typename mvec_type,
  ...
  ::rompp::mpl::enable_if_t<
    algebra::meta::is_multi_vector_wrapper_tpetra<mvec_type>::value &&
    algebra::meta::is_vector_wrapper_tpetra<vec_type>::value &&
...
template <typename mvec_type,
  ...
  ::rompp::mpl::enable_if_t<
    ...
    algebra::meta::is_vector_wrapper_tpetra<vec_type>::value and
