...
#ifndef ALGEBRA_EIGEN_MULTI_VECTOR_DOT_EIGEN_VECTOR_HPP_
#define ALGEBRA_EIGEN_MULTI_VECTOR_DOT_EIGEN_VECTOR_HPP_
...
-> algebra::Vector<
  ...
  algebra::Vector<Eigen::Matrix<sc_t, Eigen::Dynamic, 1>> c(vecB.size());
  dot(mvA,vecB,c);
  return c;
}
//--------------------------------------------------------
