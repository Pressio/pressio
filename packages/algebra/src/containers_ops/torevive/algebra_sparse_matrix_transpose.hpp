...
#ifndef ALGEBRA_MATRIX_OPERATIONS_SPARSE_MATRIX_TRANSPOSE_HPP_
#define ALGEBRA_MATRIX_OPERATIONS_SPARSE_MATRIX_TRANSPOSE_HPP_
		 ...
		 by rowmatrix transposer*/) 
{
  ...
  // algebra::Matrix<nat_t> res( *transA );
