...
#ifndef ALGEBRA_MATRIX_OPERATIONS_DENSE_MATRIX_VECTOR_PRODUCT_HPP_
#define ALGEBRA_MATRIX_OPERATIONS_DENSE_MATRIX_VECTOR_PRODUCT_HPP_

#include "../../meta/algebra_vector_meta.hpp"
#include "../../vector/concrete/algebra_vector_sharedmem_eigen.hpp"
...
template <typename matrix_type,
	  ...
	  ::rompp::mpl::enable_if_t<
	    algebra::details::traits<matrix_type>::is_matrix==1 &&
	    algebra::details::traits<matrix_type>::isEpetra==1 &&
	    algebra::details::traits<matrix_type>::is_dense==1 &&
	    algebra::details::traits<vector_type>::is_vector==1 &&
	    algebra::details::traits<vector_type>::isEpetra==1
	    > * = nullptr>
