...
#ifndef ALGEBRA_MATRIX_OPERATIONS_DENSE_MATRIX_TRANSPOSE_HPP_
#define ALGEBRA_MATRIX_OPERATIONS_DENSE_MATRIX_TRANSPOSE_HPP_
...
auto transpose(const mat_type & A)
{
  ...
  using res_t = algebra::Matrix<Eigen::Matrix<scalar_t, colsIn, rowsIn>>;
  res_t res;
