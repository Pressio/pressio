...
#ifndef ALGEBRA_VECTOR_VECTOR_PLUS_OPERATOR_SHAREDMEM_HPP_
#define ALGEBRA_VECTOR_VECTOR_PLUS_OPERATOR_SHAREDMEM_HPP_
    ...
    )
{
  ...
  return algebra::exprtemplates::SharedMemVectorBinaryExp<
    algebra::exprtemplates::plus_, T1, T2, sc_t, ord_t>(u, v);
}
