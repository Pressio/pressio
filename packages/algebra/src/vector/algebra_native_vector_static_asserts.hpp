...
#ifndef ALGEBRA_NATIVE_VECTOR_STATIC_ASSERTS_HPP_
#define ALGEBRA_NATIVE_VECTOR_STATIC_ASSERTS_HPP_
...
#define STATIC_ASSERT_IS_VECTOR_EIGEN(TYPE) \
  static_assert( algebra::meta::is_vector_eigen<TYPE>::value, \
...
#define STATIC_ASSERT_IS_VECTOR_STDLIB(TYPE) \
  static_assert( algebra::meta::is_vector_stdlib<TYPE>::value, \
...
#define STATIC_ASSERT_IS_VECTOR_EPETRA(TYPE) \
  static_assert( algebra::meta::is_vector_epetra<TYPE>::value, \
...
#define STATIC_ASSERT_IS_VECTOR_TPETRA(TYPE) \
  static_assert( algebra::meta::is_vector_tpetra<TYPE>::value, \
...
#define STATIC_ASSERT_IS_VECTOR_TPETRA_BLOCK(TYPE) \
  static_assert( algebra::meta::is_vector_tpetra_block<TYPE>::value, \
...
#define STATIC_ASSERT_IS_VECTOR_KOKKOS(TYPE) \
  static_assert( algebra::meta::is_vector_kokkos<TYPE>::value, \
...
#define STATIC_ASSERT_IS_VECTOR_BLAZE(TYPE)				\
  static_assert( algebra::meta::is_static_vector_blaze<TYPE>::value ||	\
                 algebra::meta::is_dynamic_vector_blaze<TYPE>::value,	\
...
#define STATIC_ASSERT_IS_VECTOR_ARMADILLO(TYPE)			\
  static_assert( algebra::meta::is_vector_armadillo<TYPE>::value,	\
