...
#ifndef ALGEBRA_VECTOR_VECTOR_PLUS_OPERATOR_DISTRIBUTED_HPP_
#define ALGEBRA_VECTOR_VECTOR_PLUS_OPERATOR_DISTRIBUTED_HPP_
    ...
    )
{
  ...
  return algebra::exprtemplates::DistributedVectorBinaryExp<
    algebra::exprtemplates::plus_,T1, T2, sc_t, LO_t>(u, v);
}
