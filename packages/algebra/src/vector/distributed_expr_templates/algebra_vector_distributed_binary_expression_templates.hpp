...
#ifndef ALGEBRA_VECTOR_VECTOR_DISTRIBUTED_BINARY_EXPRESSION_TEMPLATES_HPP_
#define ALGEBRA_VECTOR_VECTOR_DISTRIBUTED_BINARY_EXPRESSION_TEMPLATES_HPP_
...
class DistributedVectorBinaryExp<
	 ...
	 ::rompp::mpl::enable_if_t<
	   ...
	   !algebra::details::traits<T2>::is_shared_mem>
  >
  : public DistributedVecExpressionBase<
  DistributedVectorBinaryExp<OP_t,T1,T2,value_t,LO_t>>{
...
}}}//end namespace rompp::algebra::exprtemplates
#endif
