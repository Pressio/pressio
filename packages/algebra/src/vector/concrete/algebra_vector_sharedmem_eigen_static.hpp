...
#ifndef ALGEBRA_VECTOR_CONCRETE_VECTOR_SHAREDMEM_EIGEN_STATIC_HPP_
#define ALGEBRA_VECTOR_CONCRETE_VECTOR_SHAREDMEM_EIGEN_STATIC_HPP_
...
class Vector<wrapped_type,
	     ::rompp::mpl::enable_if_t<
	       algebra::meta::is_static_vector_eigen<wrapped_type>::value
	       >
	     >
