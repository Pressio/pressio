...
#ifndef ALGEBRA_VECTOR_CONCRETE_VECTOR_SHAREDMEM_EIGEN_DYNAMIC_HPP_
#define ALGEBRA_VECTOR_CONCRETE_VECTOR_SHAREDMEM_EIGEN_DYNAMIC_HPP_
...
#include "../../shared_base/algebra_container_printable_base.hpp"
...
class Vector<wrapped_type,
	     ::rompp::mpl::enable_if_t<
	       algebra::meta::is_dynamic_vector_eigen<wrapped_type>::value
	       >
	     >
