...
#ifdef HAVE_TRILINOS
#ifndef ALGEBRA_VECTOR_CONCRETE_VECTOR_SHAREDMEM_TEUCHOS_SERIAL_DENSE_HPP_
#define ALGEBRA_VECTOR_CONCRETE_VECTOR_SHAREDMEM_TEUCHOS_SERIAL_DENSE_HPP_
...
class Vector<wrapped_type,
	     ::rompp::mpl::enable_if_t<
	       algebra::meta::is_dense_vector_teuchos<wrapped_type>::value
	       >
	     >
