...
#ifdef HAVE_TRILINOS
#ifndef ALGEBRA_IS_VECTOR_WRAPPER_TPETRA_BLOCK_HPP_
#define ALGEBRA_IS_VECTOR_WRAPPER_TPETRA_BLOCK_HPP_
...
struct is_vector_wrapper_tpetra_block<
  T, ::rompp::mpl::enable_if_t<
       ...
       algebra::details::WrappedVectorIdentifier::TpetraBlock
       >
  > : std::true_type{};
