...
TEST(algebra_vector_sharedmem_kokkos_class, axpy){
  ...
  // using myvec_t = algebra::Vector<view_type>;
  // static_assert( algebra::details::traits<myvec_t>::is_static == 0, "" );
  // myvec_t g(a);
  
  // using view_type2 = Kokkos::View<double[11]>;
  // using myvec_t2 = algebra::Vector<view_type2>;
  // static_assert( algebra::details::traits<myvec_t2>::is_static == 1, "" );  
}
