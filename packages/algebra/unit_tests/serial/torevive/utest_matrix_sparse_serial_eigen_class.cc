...
template<typename T>
struct algebra_matrix_sparse_serial_eigen_classTest
  : public ::testing::Test{
public:
  using native_t = typename T::mat_t;
  using mymat_t = algebra::Matrix<native_t>;
  using matTrait = algebra::details::traits<mymat_t>;
...
typedef ::testing::Types< typesEig<double,Eigen::RowMajor,int>, 
			  ...
			  > MyTypes;
TYPED_TEST_CASE(algebra_matrix_sparse_serial_eigen_classTest, MyTypes);

TYPED_TEST(algebra_matrix_sparse_serial_eigen_classTest, constructor){
  this->checkConstructor();
}

TYPED_TEST(algebra_matrix_sparse_serial_eigen_classTest, filling){
  this->checkFilling();
}

TYPED_TEST(algebra_matrix_sparse_serial_eigen_classTest, queryWrappedData){
  this->checkQuery();
}

TYPED_TEST(algebra_matrix_sparse_serial_eigen_classTest, additionOperator){
  this->checkAdditionOperator();
}

TYPED_TEST(algebra_matrix_sparse_serial_eigen_classTest, subtractionOperator){
  this->checkSubtractionOperator();
}

TYPED_TEST(algebra_matrix_sparse_serial_eigen_classTest, starOperator){
  this->checkStarOperator();
}

TYPED_TEST(algebra_matrix_sparse_serial_eigen_classTest, compoundAddOperator){
  this->checkCompoundAddOperator();
}

TYPED_TEST(algebra_matrix_sparse_serial_eigen_classTest, compoundSubOperator){
  this->checkCompoundSubOperator();
}



// TEST(algebra_matrix_sparse_serial_eigen_class, transpose)
// {
...
//   auto tm1 = algebra::mat_ops::transpose(m4);
