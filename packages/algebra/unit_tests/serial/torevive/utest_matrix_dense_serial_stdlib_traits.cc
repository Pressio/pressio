...
template<typename T>
struct algebra_matrix_dense_serial_stdlib_traitsTest
  : public ::testing::Test{
public:
  ...
  void check(){
    ...
    ASSERT_TRUE(vecTrait::wrapped_matrix_identifier 
      == algebra::details::WrappedMatrixIdentifier::CppStdLib);
...
typedef ::testing::Types<double, int, unsigned int,
			 ...
			 > MyTypes;
TYPED_TEST_CASE(algebra_matrix_dense_serial_stdlib_traitsTest, MyTypes);

TYPED_TEST(algebra_matrix_dense_serial_stdlib_traitsTest, traits)
{
