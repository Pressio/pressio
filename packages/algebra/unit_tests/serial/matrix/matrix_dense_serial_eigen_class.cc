...
using mymat_t = rompp::algebra::Matrix<nat_t>;


TEST(algebra_matrix_dense_eigen_dynamic_class,
     constructor)
{
  // STATIC_ASSERT_IS_ALGEBRA_MATRIX_WRAPPER(mymat_t);
  //using matTrait = rompp::algebra::details::traits<mymat_t>;
...
// TEST(algebra_matrix_dense_eigen_dynamic_class, additionOperator)
// {
//   using nat_t = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>;
//   using mymat_t = algebra::Matrix<nat_t>;
...
// TEST(algebra_matrix_dense_eigen_dynamic_class, substractOperator)
// {
//   using nat_t = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>;
//   using mymat_t = algebra::Matrix<nat_t>;
...
// TEST(algebra_matrix_dense_eigen_dynamic_class, starOperator)
// {
//   using nat_t = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>;
//   using mymat_t = algebra::Matrix<nat_t>;
...
// TEST(algebra_matrix_dense_eigen_dynamic_class, transposeDynamic)
// {
//   using nat_t = Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic>;
//   using mymat_t = algebra::Matrix<nat_t>;
...
//   auto tm1 = algebra::mat_ops::transpose(m1);
...
// TEST(algebra_matrix_dense_eigen_dynamic_class, transposeStatic)
// {
