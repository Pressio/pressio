...
using myvec_t = rompp::algebra::Vector<eigvec_t>;


TEST(algebra_vector_serial_eigen_dynamic_class,
     constructor){

  using vecTrait = rompp::algebra::details::traits<myvec_t>;
  ASSERT_TRUE(vecTrait::wrapped_vector_identifier 
  == rompp::algebra::details::WrappedVectorIdentifier::EigenColDynamic);
...
TEST(algebra_vector_serial_eigen_dynamic_class,
  ...
  a(0) = 1.; a(1) = 2.;
  a(2) = -1.; a(3) = 3.;
  auto res = rompp::algebra::ops::norm1(a);
...
TEST(algebra_vector_serial_eigen_dynamic_class,
  ...
  myvec_t a(3);
  a(0) = 1.; a(1) = 2.; a(2) = -2.;
  auto res = rompp::algebra::ops::norm2(a);
...
TEST(algebra_vector_serial_eigen_dynamic_class,
  ...
  myvec_t a(3);
  a(0) = 1.; a(1) = 2.; a(2) = -2.;
  auto res = rompp::algebra::ops::min(a);
...
TEST(algebra_vector_serial_eigen_dynamic_class,
  ...
  myvec_t a(3);
  a(0) = 1.; a(1) = 2.; a(2) = -2.;
  auto res = rompp::algebra::ops::max(a);
  EXPECT_DOUBLE_EQ( res, 2.0);
}
