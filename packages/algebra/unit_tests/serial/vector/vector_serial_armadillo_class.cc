...
TEST(algebra_vector_serial_armadillo_class, Constructor)
{
  ...
  using myvec_t = algebra::Vector<nat_t>;
  ...
  ASSERT_FALSE(vecTrait::wrapped_vector_identifier 
    == algebra::details::WrappedVectorIdentifier::Eigen);
...
// TEST(algebra_vector_serial_eigen_class, queryWrappedData)
// {
// 	using namespace rompp;
...
// TEST(algebra_vector_serial_eigen_class, sizeResize)
// {
// 	using namespace rompp;
//   using eigvec_t = Eigen::Matrix<double, Eigen::Dynamic, 1>;
//   using myvec_t = algebra::Vector<eigvec_t>;
...
// TEST(algebra_vector_serial_eigen_class, subscriptOperator)
// {
//   using namespace rompp;
//   using eigvec_t = Eigen::Matrix<double, Eigen::Dynamic, 1>;
//   using myvec_t = algebra::Vector<eigvec_t>;
...
// TEST(algebra_vector_serial_eigen_class, additionOperator)
// {
// 	using namespace rompp;
//   using eigvec_t = Eigen::Matrix<double, Eigen::Dynamic, 1>;
//   using myvec_t = algebra::Vector<eigvec_t>;
...
// TEST(algebra_vector_serial_eigen_class, substractOperator)
// {
// 	using namespace rompp;
//   using eigvec_t = Eigen::Matrix<double, Eigen::Dynamic, 1>;
//   using myvec_t = algebra::Vector<eigvec_t>;
...
// TEST(algebra_vector_serial_eigen_class, starOperator)
// {
// 	using namespace rompp;
//   using eigvec_t = Eigen::Matrix<double, Eigen::Dynamic, 1>;
//   using myvec_t = algebra::Vector<eigvec_t>;
...
// TEST(algebra_vector_serial_eigen_class, CompoundAssignAddOperator)
// {
// 	using namespace rompp;
//   using eigvec_t = Eigen::Matrix<double, Eigen::Dynamic, 1>;
//   using myvec_t = algebra::Vector<eigvec_t>;
...
// TEST(algebra_vector_serial_eigen_class, CompoundAssignSubtractOperator)
// {
// 	using namespace rompp;
//   using eigvec_t = Eigen::Matrix<double, Eigen::Dynamic, 1>;
//   using myvec_t = algebra::Vector<eigvec_t>;
