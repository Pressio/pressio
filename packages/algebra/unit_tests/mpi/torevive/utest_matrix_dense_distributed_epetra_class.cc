...
TEST_F(algebra_matrix_dense_distributed_epetraFix, EpetraDenseDistConstructor)
{
  using nat_t = Epetra_MultiVector;
  using my_t = algebra::Matrix<nat_t>;
  STATIC_ASSERT_IS_ALGEBRA_MATRIX_WRAPPER(my_t);
...
// TEST_F(algebra_matrix_dense_distributed_epetraFix, transpose)
// {
//   using nat_t = Epetra_MultiVector;
//   using my_t = algebra::Matrix<nat_t>;
//   STATIC_ASSERT_IS_ALGEBRA_MATRIX_WRAPPER(my_t);
...
//   auto CC = algebra::mat_ops::transpose(A);
