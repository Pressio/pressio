...
TEST_F(epetraSparseMatR7MultiVectorR9C4Fixture,
  ...
  using mymv_w_t = rompp::algebra::MultiVector<Epetra_MultiVector>;  
  ASSERT_TRUE(rompp::algebra::meta::is_sparse_matrix_wrapper_epetra<mymat_w_t>::value);
  ASSERT_TRUE(rompp::algebra::meta::is_multi_vector_wrapper_epetra<mymv_w_t>::value);
  ...
  // compute prod
  auto C = rompp::algebra::ops::product(*sm_, *mv_);
...
//   // // compute prduct
//   auto C = rompp::algebra::ops::product(*sm_, *mv_, true);
//   C.data()->Print(std::cout);
// }
