...
TEST_F(tpetraMultiVectorGlobSize15Fixture, Constructor){
  ...
  using mvec_t = algebra::MultiVector<typename tpetraMultiVectorGlobSize15Fixture::mvec_t>;
  mvec_t a( *x_ );
  mvec_t a3( a );
}
...
TEST_F(tpetraMultiVectorGlobSize15Fixture,
       localSize){
  using namespace rompp;
  using mymvec_t = algebra::MultiVector<typename tpetraMultiVectorGlobSize15Fixture::mvec_t>;
  mymvec_t v1( *x_ );
...
TEST_F(tpetraMultiVectorGlobSize15Fixture,
  ...
  using mymvec_t = algebra::MultiVector<native_t>;
  mymvec_t v1( *x_ );
...
TEST_F(tpetraMultiVectorGlobSize15Fixture,
  ...
  using mymvec_t = algebra::MultiVector<nvec_t>;
  mymvec_t v1( *x_ );
...
TEST_F(tpetraMultiVectorGlobSize15Fixture,
  ...
  using namespace rompp;
  using nvec_t = typename tpetraMultiVectorGlobSize15Fixture::mvec_t;
  using myvec_t = algebra::MultiVector<nvec_t>;
  myvec_t v1( *x_ );
  auto const & mapO = v1.getDataMap();
  ::testing::StaticAssertTypeEq<decltype(mapO),
  				const typename tpetraMultiVectorGlobSize15Fixture::map_t & >();
