...
{
  using stepper_t =
    impl::explicitEulerStepperImpl<state_type,
				   residual_type,
				   scalar_type,
				   model_type,
				   time_type,
...
// 	 typename residual_policy_type
// 	 >
// struct traits<explicitRungeKutta4Stepper<state_type, residual_type,
// 					 scalar_type,
// 					 model_type, time_type,
// 					 residual_policy_type> >
// {
//   using stepper_t = explicitRungeKutta4Stepper<state_type,
// 					       residual_type, scalar_type,
// 					       model_type, time_type,
// 					       residual_policy_type>;
//   using state_t =  state_type;
//   using residual_t = residual_type;
...
// struct traits< implicitEulerStepper<state_type, residual_type,
...
// {
//   using stepper_t = implicitEulerStepper<state_type, residual_type,
// 					 jacobian_type,
