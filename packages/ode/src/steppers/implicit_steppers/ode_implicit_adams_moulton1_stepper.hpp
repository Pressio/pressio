...
class implicitAdamsMoulton1Stepper<state_type, residual_type,
			  ...
			  typename std::enable_if<
			    ...
			    >::type>
  : public impl::implicitAdamsMoulton1StepperImpl<state_type, residual_type,
					 jacobian_type, scalar_type,
					 model_type, time_type,
					 solver_policy_type,
...
{
public:
  using res_pol_t = ode::policy::implicitAdamsMoulton1StandardResidual<
  state_type, residual_type, model_type, time_type>;

  using jac_pol_t = ode::policy::implicitAdamsMoulton1StandardJacobian<
