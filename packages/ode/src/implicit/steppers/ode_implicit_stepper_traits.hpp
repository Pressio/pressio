...
template <typename state_type, typename residual_type,
	  typename jacobian_type, typename model>
struct implClassHelper<ImplicitEnum::Euler, state_type, residual_type,
...
struct implClassHelper<ImplicitEnum::BDF2, state_type, residual_type,
  ...
  using residual_policy_t = res_pol_t;
  using jacobian_policy_t = jac_pol_t;
  using impl_t = impl::ImplicitBDF2StepperImpl<state_type, residual_type, jacobian_type,
