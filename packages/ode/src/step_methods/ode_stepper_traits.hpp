	      ...
	      >
{
  ...
  // 	   typename scalar_type,
  // 	   typename state_resizer_fctor_type,
  // 	   typename model_type,
  // 	   typename residual_policy_type,
  ...
  // 				      state_resizer_fctor_type, model_type, residual_policy_type,
  ...
  // 					   scalar_type, state_resizer_fctor_type, model_type,
  ...
  //   using scalar_t = scalar_type;    
  //   using resizer_t = state_resizer_fctor_type;
  //   using model_t = model_type;
  //   using residual_policy_t = residual_policy_type;
