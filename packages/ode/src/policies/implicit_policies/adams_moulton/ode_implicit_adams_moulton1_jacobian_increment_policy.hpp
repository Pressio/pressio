...
#ifndef ODE_IMPLICIT_ADAMS_MOULTON1_JACOBIAN_INCREMENT_POLICY_HPP_
#define ODE_IMPLICIT_ADAMS_MOULTON1_JACOBIAN_INCREMENT_POLICY_HPP_
...
class implicitAdamsMoulton1IncrementJacobian
  : public implicitAdamsMoulton1JacobianPolicyBase<implicitAdamsMoulton1IncrementJacobian,
					   state_type, jacobian_type,
					   model_type, time_type>,
  public advanceIncrementPolicyBase<implicitAdamsMoulton1IncrementJacobian,
			     state_type, jacobian_type,
			     model_type, time_type>
{
private:
  using baseIncr_t = advanceIncrementPolicyBase<implicitAdamsMoulton1IncrementJacobian,
						state_type, jacobian_type,
						model_type, time_type>;

public:
  implicitAdamsMoulton1IncrementJacobian(const state_type & y0)
    : baseIncr_t(y0){}
  ~implicitAdamsMoulton1IncrementJacobian() = default;
...
private:
  friend implicitAdamsMoulton1JacobianPolicyBase<implicitAdamsMoulton1IncrementJacobian,
           state_type,jacobian_type,
           model_type, time_type>;
  friend baseIncr_t;
