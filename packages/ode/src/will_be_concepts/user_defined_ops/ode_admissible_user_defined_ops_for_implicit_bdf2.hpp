...
template<
  ...
  >
struct ode_admissible_user_defined_ops_for_implicit_bdf2 : std::false_type{};
...
template<
  ...
  typename jacobian_t
  >
struct ode_admissible_user_defined_ops_for_implicit_bdf2<
  T, scalar_t, state_t, residual_t, jacobian_t,
    mpl::enable_if_t<
      ::pressio::ops::meta::has_method_do_update_three_terms<
