...
struct GNPicker{
  ...
  // store the type
  using linear_solver_t = ::tinympl::variadic::at_or_t<void, ic2::value, Args...>;
  ...
  using ic3 = ::tinympl::variadic::find_if_unary_pred_t<
  ...
  using hessian_t = ::tinympl::variadic::at_or_t<linear_solver_matrix_t, ic3::value, Args...>;
