...
using has_jacobian_callable_with_two_args = decltype(std::declval<T>().jacobian(std::declval<FirstArg const&>()));


template <typename T>
struct system_traits {
  typedef typename core::meta::is_detected<has_public_state_type, T>::type state_type;
  typedef typename core::meta::is_detected<has_public_matrix_type, T>::type matrix_type;

  static constexpr bool has_residual_methods = 
    core::meta::is_detected<has_residual_callable_with_one_arg, state_type>::value &&
    core::meta::is_detected<has_residual_callable_with_two_args, state_type>::value;
  
  static constexpr bool has_jacobian_methods = 
    core::meta::is_detected<has_jacobian_callable_with_one_arg, state_type>::value &&
    core::meta::is_detected<has_jacobian_callable_with_two_args, state_type, matrix_type>::value;
