...
struct DefaultHelper<::pressio::ode::implicitmethods::Euler, fom_state_t, wls_state_t>{
  using type = ::pressio::rom::wls::ode::impl::ImplicitEuler<fom_state_t, wls_state_t>;
};

//BDF2 specialization
template <typename fom_state_t, typename wls_state_t>
struct DefaultHelper<::pressio::ode::implicitmethods::BDF2, fom_state_t, wls_state_t>{
  using type = ::pressio::rom::wls::ode::impl::BDF2<fom_state_t, wls_state_t>;
};

//Explicit Euler specialization
template <typename fom_state_t, typename wls_state_t>
struct DefaultHelper<::pressio::ode::explicitmethods::Euler, fom_state_t, wls_state_t>{
  using type = ::pressio::rom::wls::ode::impl::ExplicitEuler<fom_state_t, wls_state_t>;
};

} //ena namespace pressio::rom::wls::ode::helpers::impl

template <typename ode_tag, typename fom_state_t, typename wls_state_t>
using ode_policies_t = typename impl::DefaultHelper<ode_tag,fom_state_t, wls_state_t>::type;

}}}}} //ena namespace pressio::rom::wls::ode::helpers
#endif
