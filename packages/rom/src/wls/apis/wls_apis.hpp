...
using  WlsSystemHessianAndGradientApi = pressio::rom::wls::impl::WlsSystemHessianAndGradientApi<fom_type,wls_state_type,decoder_type,ode_type,aux_states_container_type,hessian_type>;
}}}
