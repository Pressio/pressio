...
#include "CORE_ALL"
#include "../../src/qr_eigen_dense_matrix.hpp"


TEST(qr_factorization,
     EigenDenseMatrixQRFactorization){
  ...
  A(3,1) = 4.;
  A(4,2) = -1.; A(4,3) = -4.;
  A(5,0) = 0.2; A(5,1) = 5.;  A(5,2) = 1.;
  A(6,0) = 1.; A(6,1) = 1.1; A(6,2) = 1.25; A(6,3) = -3.;
  A(7,2) = 1.; A(7,1) = 0.1111; A(7,3) = 6.;
