...
#ifndef UTILS_LOGGER_SPDLOG_SINKS_STDOUT_SINKS_INL_H_
#define UTILS_LOGGER_SPDLOG_SINKS_STDOUT_SINKS_INL_H_
...
#endif  // UTILS_LOGGER_SPDLOG_SINKS_STDOUT_SINKS_INL_H_
