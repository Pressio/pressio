...
#ifndef UTILS_LOGGER_SPDLOG_SINKS_WIN_EVENTLOG_SINK_H_
#define UTILS_LOGGER_SPDLOG_SINKS_WIN_EVENTLOG_SINK_H_
...
#endif  // UTILS_LOGGER_SPDLOG_SINKS_WIN_EVENTLOG_SINK_H_
