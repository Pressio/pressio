...
.. code-block:: cpp
  ...
  template<
    class StepperType, class StateType, class TimeType, class ...Args
  >
  ...
  template<
    ...
    class StepSizeSetterType, class ...Args
   >
  ...
  template<
   class StepperType,  class StateType, class TimeType, 
   class ObserverType, class ...Args
   >
  void advance_n_steps_and_observe(StepperType & stepper,               (3)
                                  StateType & state,
                                  const TimeType start_time,
                                  const TimeType time_step_size,
                                  const pressio::ode::step_count_type num_steps,
