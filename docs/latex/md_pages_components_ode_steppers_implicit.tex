...
Public namespace\+: {\ttfamily pressio\+::ode}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md61}{}\doxysection{Overview}\label{md_pages_components_ode_steppers_implicit_autotoc_md61}
Provides functionalities to create a stepper suitable for implicit methods. Recall that implicit methods calculate the state of a system at the next time by solving a system of equations involving both the current state of the system and the later one. An implicit stepper is an object that knows how to take one {\itshape implicit} step.
...
Here, $y$ is the full-\/order model (FOM) state, $f$ the FOM velocity, $t$ is time, and $R$ is the residual.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md62}{}\doxysection{API for continuous-\/time systems}\label{md_pages_components_ode_steppers_implicit_autotoc_md62}
...
The create functions above return an instance of the desired stepper, which satisfies the \char`\"{}steppable\char`\"{} concept discussed \href{/Users/fnrizzi/Desktop/work/ROM/gitrepos/pressio/docs/html/md_pages_components_ode_advance.html}{\texttt{ here}}. Therefore, one can use the \char`\"{}advancers\char`\"{} functions to step forward.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md63}{}\doxysubsection{Parameters}\label{md_pages_components_ode_steppers_implicit_autotoc_md63}
...
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md64}{}\doxysubsection{Requirements}\label{md_pages_components_ode_steppers_implicit_autotoc_md64}
...
\item if {\ttfamily State\+Type} is the type deduced for {\ttfamily state} passed to {\ttfamily create\+\_\+...}, the following must hold\+:~\newline
...
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md65}{}\doxysubsection{If you use custom policies\+:}\label{md_pages_components_ode_steppers_implicit_autotoc_md65}
...
\end{longtabu}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md66}{}\doxysubsection{Example usage}\label{md_pages_components_ode_steppers_implicit_autotoc_md66}
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md67}{}\doxysubsection{Required specializations for custom types}\label{md_pages_components_ode_steppers_implicit_autotoc_md67}
...
Obviously, if you want to use pressio nonlinear solvers, then you need provide also the specializations described \href{md_pages_components_nonlinsolvers.html}{\texttt{ here}}.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md68}{}\doxysection{API for discrete-\/time systems}\label{md_pages_components_ode_steppers_implicit_autotoc_md68}
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md69}{}\doxysubsection{Parameters}\label{md_pages_components_ode_steppers_implicit_autotoc_md69}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md70}{}\doxysubsection{Requirements}\label{md_pages_components_ode_steppers_implicit_autotoc_md70}
