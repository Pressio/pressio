...
Here, $y$ is the full-\/order model (FOM) state, $f$ the FOM velocity, $t$ is time, and $R$ is the residual.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md61}{}\doxysection{API for continuous-\/time systems}\label{md_pages_components_ode_steppers_implicit_autotoc_md61}
...
The create functions above return an instance of the desired stepper, which satisfies the \char`\"{}steppable\char`\"{} concept discussed \href{/Users/fnrizzi/Desktop/work/ROM/gitrepos/pressio/docs/html/md_pages_components_ode_advance.html}{\texttt{ here}}. Therefore, one can use the \char`\"{}advancers\char`\"{} functions to step forward.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md62}{}\doxysubsection{Parameters}\label{md_pages_components_ode_steppers_implicit_autotoc_md62}
...
\end{longtabu}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md65}{}\doxysubsection{Example usage}\label{md_pages_components_ode_steppers_implicit_autotoc_md65}
