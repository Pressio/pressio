...
Here, $y$ is the state, $f$ the velocity, $t$ is time, and $R$ is the residual.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md62}{}\doxysection{API for continuous-\/time systems}\label{md_pages_components_ode_steppers_implicit_autotoc_md62}
...
\end{longtabu}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md63}{}\doxysubsection{Parameters}\label{md_pages_components_ode_steppers_implicit_autotoc_md63}
...
\end{longtabu}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md66}{}\doxysubsection{What to do after a stepper is created?}\label{md_pages_components_ode_steppers_implicit_autotoc_md66}
