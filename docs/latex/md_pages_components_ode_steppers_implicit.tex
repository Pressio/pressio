...
The create functions above return an instance of the desired stepper, which satisfies the \char`\"{}steppable\char`\"{} concept discussed \href{/Users/fnrizzi/Desktop/work/ROM/gitrepos/pressio/docs/html/md_pages_components_ode_advance.html}{\texttt{ here}}. Therefore, one can use the \char`\"{}advancers\char`\"{} functions to step forward.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md42}{}\doxysubsection{Parameters}\label{md_pages_components_ode_steppers_implicit_autotoc_md42}
...
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md43}{}\doxysubsection{Requirements}\label{md_pages_components_ode_steppers_implicit_autotoc_md43}
...
\end{longtabu}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md45}{}\doxysubsection{Example usage}\label{md_pages_components_ode_steppers_implicit_autotoc_md45}
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md46}{}\doxysubsection{Required specializations for custom types}\label{md_pages_components_ode_steppers_implicit_autotoc_md46}
...
\end{DoxyCode}
 Obviously, if you want to use pressio nonlinear solvers, then you need provide also the specializations described \href{md_pages_components_nonlinsolvers.html}{\texttt{ here}}.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md47}{}\doxysection{API for discrete-\/time systems}\label{md_pages_components_ode_steppers_implicit_autotoc_md47}
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md48}{}\doxysubsection{Parameters}\label{md_pages_components_ode_steppers_implicit_autotoc_md48}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md49}{}\doxysubsection{Requirements}\label{md_pages_components_ode_steppers_implicit_autotoc_md49}
