...
Public namespace\+: {\ttfamily pressio\+::ode}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md45}{}\doxysection{Overview}\label{md_pages_components_ode_steppers_implicit_autotoc_md45}
...
Here, $y$ is the full-\/order model (FOM) state, $f$ the FOM velocity, $t$ is time, and $R$ is the residual.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md46}{}\doxysection{API for continuous-\/time systems}\label{md_pages_components_ode_steppers_implicit_autotoc_md46}
...
The create functions above return an instance of the desired stepper, which satisfies the \char`\"{}steppable\char`\"{} concept discussed \href{/Users/fnrizzi/Desktop/work/ROM/gitrepos/pressio/docs/html/md_pages_components_ode_advance.html}{\texttt{ here}}. Therefore, one can use the \char`\"{}advancers\char`\"{} functions to step forward.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md47}{}\doxysubsection{Parameters}\label{md_pages_components_ode_steppers_implicit_autotoc_md47}
...
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md48}{}\doxysubsection{Requirements}\label{md_pages_components_ode_steppers_implicit_autotoc_md48}
...
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md49}{}\doxysubsection{If you use custom policies\+:}\label{md_pages_components_ode_steppers_implicit_autotoc_md49}
...
\end{longtabu}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md50}{}\doxysubsection{Example usage}\label{md_pages_components_ode_steppers_implicit_autotoc_md50}
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md51}{}\doxysubsection{Required specializations for custom types}\label{md_pages_components_ode_steppers_implicit_autotoc_md51}
...
\end{DoxyCode}
 Obviously, if you want to use pressio nonlinear solvers, then you need provide also the specializations described \href{md_pages_components_nonlinsolvers.html}{\texttt{ here}}.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md52}{}\doxysection{API for discrete-\/time systems}\label{md_pages_components_ode_steppers_implicit_autotoc_md52}
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md53}{}\doxysubsection{Parameters}\label{md_pages_components_ode_steppers_implicit_autotoc_md53}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md54}{}\doxysubsection{Requirements}\label{md_pages_components_ode_steppers_implicit_autotoc_md54}
