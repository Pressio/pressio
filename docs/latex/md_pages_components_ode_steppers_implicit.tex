...
Public namespace\+: {\ttfamily pressio\+::ode} \hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md57}{}\doxysection{Overview}\label{md_pages_components_ode_steppers_implicit_autotoc_md57}
...
Here, $y$ is the state, $f$ the velocity, $t$ is time, and $R$ is the residual.\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md58}{}\doxysection{API for continuous-\/time systems}\label{md_pages_components_ode_steppers_implicit_autotoc_md58}
...
\end{longtabu}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md59}{}\doxysubsection{Parameters}\label{md_pages_components_ode_steppers_implicit_autotoc_md59}
...
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md60}{}\doxysubsection{Requirements}\label{md_pages_components_ode_steppers_implicit_autotoc_md60}
...
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md61}{}\doxysubsection{If you use custom policies\+:}\label{md_pages_components_ode_steppers_implicit_autotoc_md61}
...
\end{longtabu}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md62}{}\doxysubsection{What to do after a stepper is created?}\label{md_pages_components_ode_steppers_implicit_autotoc_md62}
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md63}{}\doxysubsection{Required specializations for custom types}\label{md_pages_components_ode_steppers_implicit_autotoc_md63}
...
~\newline
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md64}{}\doxysection{API for discrete-\/time systems}\label{md_pages_components_ode_steppers_implicit_autotoc_md64}
todo FINISH
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_implicit_autotoc_md65}{}\doxysubsection{Parameters and Requirements}\label{md_pages_components_ode_steppers_implicit_autotoc_md65}
