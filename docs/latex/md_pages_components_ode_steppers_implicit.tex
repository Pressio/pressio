...
\DoxyCodeLine{\textcolor{keyword}{auto} create\_implicit\_stepper(pressio::ode::SteppersE name,}
...
\DoxyCodeLine{  \textcolor{keyword}{const} \textcolor{keyword}{auto} scheme = pode::SteppersE::BDF1;}
