...
Preparing an adapter should only involve {\itshape exposing} some operators in your application. Also, note that to write an adapter for {\itshape your} application you only need {\itshape your} application data structures. Pressio does NOT require you to provide information that you don\textquotesingle{}t already have. In fact, pressio needs to access {\itshape standard} information/operators that your application already assembles in some form or another. In some cases, these operators might not be fully exposed yet, so all we need is for you to make them accessible. As such, writing an adapter is, in most cases, relatively simple. 
\end{DoxyParagraph}
...
Intended for when your FOM application is expressed as \[ \boldsymbol{R}(\boldsymbol{y}; \boldsymbol{\mu}) = 0 \] where $y$ is your FOM state, and $R$ is the residual todo finish. \hypertarget{md_pages_components_rom_fom_apis_autotoc_md78}{}\doxysubsubsection{Synopsis}\label{md_pages_components_rom_fom_apis_autotoc_md78}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_fom_apis_autotoc_md79}{}\doxysubsubsection{Notes}\label{md_pages_components_rom_fom_apis_autotoc_md79}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_fom_apis_autotoc_md82}{}\doxysubsubsection{Notes}\label{md_pages_components_rom_fom_apis_autotoc_md82}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_fom_apis_autotoc_md85}{}\doxysubsubsection{Notes}\label{md_pages_components_rom_fom_apis_autotoc_md85}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_fom_apis_autotoc_md88}{}\doxysubsubsection{Notes}\label{md_pages_components_rom_fom_apis_autotoc_md88}
...
~\newline
 \DoxyHorRuler{0}
 ~\newline
\hypertarget{md_pages_components_rom_fom_apis_autotoc_md89}{}\doxysection{What can you use where?}\label{md_pages_components_rom_fom_apis_autotoc_md89}
...
~\newline
 \DoxyHorRuler{0}
 ~\newline
\hypertarget{md_pages_components_rom_fom_apis_autotoc_md90}{}\doxysection{Frequently Asked Questions}\label{md_pages_components_rom_fom_apis_autotoc_md90}
