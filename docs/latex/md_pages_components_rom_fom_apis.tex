...
~\newline
\hypertarget{md_pages_components_rom_fom_apis_autotoc_md90}{}\doxysection{Continuous-\/time API\+: Velocity and Jacobian action}\label{md_pages_components_rom_fom_apis_autotoc_md90}
This API is intended for any system expressible in {\itshape time-\/continuous} form as above, but you expose both the right-\/hand-\/side of your FOM application as well as the action of the velocity\textquotesingle{}s Jacobian on some operand (more on this later).\hypertarget{md_pages_components_rom_fom_apis_autotoc_md91}{}\doxysubsection{Synopsis}\label{md_pages_components_rom_fom_apis_autotoc_md91}
...
~\newline
\hypertarget{md_pages_components_rom_fom_apis_autotoc_md93}{}\doxysection{Discrete-\/time API}\label{md_pages_components_rom_fom_apis_autotoc_md93}
This API is intended for any system expressible in a discrete-\/time form as \[ \boldsymbol{R}(\boldsymbol{y_{n+1}}, \boldsymbol{y_{n}}, \boldsymbol{y_{n-1}}, ..., t_{n+1}, dt_{n+1}; ...) = \boldsymbol{0} \] where $y$ is the full-\/order model (FOM) state, $t$ is time, and $R$ is the residual. todo finish.\hypertarget{md_pages_components_rom_fom_apis_autotoc_md94}{}\doxysubsection{Synopsis}\label{md_pages_components_rom_fom_apis_autotoc_md94}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_fom_apis_autotoc_md95}{}\doxysubsection{Usage}\label{md_pages_components_rom_fom_apis_autotoc_md95}
...
~\newline
\hypertarget{md_pages_components_rom_fom_apis_autotoc_md96}{}\doxysection{Should you prefer the continuous-\/time or discrete-\/time API?}\label{md_pages_components_rom_fom_apis_autotoc_md96}
