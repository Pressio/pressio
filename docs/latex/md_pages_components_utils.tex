...
Public namespaces\+: {\ttfamily pressio}, {\ttfamily pressio\+::utils} \hypertarget{md_pages_components_utils_autotoc_md151}{}\doxysection{Logger}\label{md_pages_components_utils_autotoc_md151}
One of the main functionalities inside {\ttfamily utils} is the logger. To implement the pressio logging functionalities, we have used \href{https://github.com/gabime/spdlog}{\texttt{ spdlog}}, modified a subset of it, for example to work seamlessly with MPI.
...
\begin{DoxyEnumerate}
\item insert a {\ttfamily define} statement to set the {\itshape minimum} level {\itshape before} including the utils header
\item initialize and finalize the logger singleton 
\end{DoxyEnumerate}
...
\DoxyCodeLine{}
\DoxyCodeLine{\textcolor{comment}{// this is needed since it contains the logging code}}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md152}{}\doxysubsection{Initializing and finalizing}\label{md_pages_components_utils_autotoc_md152}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md153}{}\doxysubsection{If running with MPI}\label{md_pages_components_utils_autotoc_md153}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md155}{}\doxysubsection{Resetting the level}\label{md_pages_components_utils_autotoc_md155}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md156}{}\doxysubsection{The loggin macros}\label{md_pages_components_utils_autotoc_md156}
