...
Public namespaces\+: {\ttfamily pressio} and {\ttfamily pressio\+::utils}.\hypertarget{md_pages_components_utils_autotoc_md114}{}\doxysection{Logger}\label{md_pages_components_utils_autotoc_md114}
...
\begin{DoxyParagraph}{By default the logger is disabled, here is how to enable it.}

\end{DoxyParagraph}
If you just {\ttfamily \#include$<$pressio/utils.\+hpp$>$} and expect logging, you will be disappointed! ~\newline
 By default, all logging is disabled for performance reasons. To enable and use it, you need to do two things\+:
\begin{DoxyEnumerate}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md115}{}\doxysubsection{Initializing}\label{md_pages_components_utils_autotoc_md115}
...
If we were to run this with N ranks, we would obtain two files {\ttfamily log\+\_\+file.\+txt\+\_\+0}, and {\ttfamily log\+\_\+file.\+txt\+\_\+1}. Currently, the logger works only for the world communicator. We will later extend the API to accept a communicator object.\hypertarget{md_pages_components_utils_autotoc_md116}{}\doxysubsection{Finalizing}\label{md_pages_components_utils_autotoc_md116}

\begin{DoxyCode}{0}
\DoxyCodeLine{plog::finalize();}

\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md117}{}\doxysubsection{Levels}\label{md_pages_components_utils_autotoc_md117}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md118}{}\doxysubsection{Resetting the level}\label{md_pages_components_utils_autotoc_md118}
If you want, you can use the define statement to set the min level, but then at runtime reset it as follows\+:
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md119}{}\doxysubsection{The loggin macros}\label{md_pages_components_utils_autotoc_md119}
