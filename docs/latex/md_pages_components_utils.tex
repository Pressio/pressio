...
Public namespaces\+: {\ttfamily pressio} and {\ttfamily pressio\+::utils}.\hypertarget{md_pages_components_utils_autotoc_md128}{}\doxysection{Logger}\label{md_pages_components_utils_autotoc_md128}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md129}{}\doxysubsection{Initializing}\label{md_pages_components_utils_autotoc_md129}
...
If we were to run this with N ranks, we would obtain two files {\ttfamily log\+\_\+file.\+txt\+\_\+0}, and {\ttfamily log\+\_\+file.\+txt\+\_\+1}. Currently, the logger works only for the world communicator. We will later extend the API to accept a communicator object.\hypertarget{md_pages_components_utils_autotoc_md130}{}\doxysubsection{Finalizing}\label{md_pages_components_utils_autotoc_md130}

\begin{DoxyCode}{0}
\DoxyCodeLine{plog::finalize();}

\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md131}{}\doxysubsection{Levels}\label{md_pages_components_utils_autotoc_md131}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md132}{}\doxysubsection{Resetting the level}\label{md_pages_components_utils_autotoc_md132}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md133}{}\doxysubsection{The loggin macros}\label{md_pages_components_utils_autotoc_md133}
