...
Public namespaces\+: {\ttfamily pressio} and {\ttfamily pressio\+::utils}.\hypertarget{md_pages_components_utils_autotoc_md96}{}\doxysection{Logger}\label{md_pages_components_utils_autotoc_md96}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md97}{}\doxysubsection{Initializing}\label{md_pages_components_utils_autotoc_md97}
...
If we were to run this with N ranks, we would obtain two files {\ttfamily log\+\_\+file.\+txt\+\_\+0}, and {\ttfamily log\+\_\+file.\+txt\+\_\+1}. Currently, the logger works only for the world communicator. We will later extend the API to accept a communicator object.\hypertarget{md_pages_components_utils_autotoc_md98}{}\doxysubsection{Finalizing}\label{md_pages_components_utils_autotoc_md98}

\begin{DoxyCode}{0}
\DoxyCodeLine{plog::finalize();}

\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md99}{}\doxysubsection{Levels}\label{md_pages_components_utils_autotoc_md99}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md100}{}\doxysubsection{Resetting the level}\label{md_pages_components_utils_autotoc_md100}
...
\end{DoxyCode}
\hypertarget{md_pages_components_utils_autotoc_md101}{}\doxysubsection{The loggin macros}\label{md_pages_components_utils_autotoc_md101}
