...
\end{DoxyParagraph}
\hypertarget{md_pages_getstarted_build_tests_eigen_autotoc_md29}{}\doxysection{Prerequisites}\label{md_pages_getstarted_build_tests_eigen_autotoc_md29}

\begin{DoxyItemize}
\item C and C++11 compilers\+: either Clang or G\+NU
\item C\+Make $>$= 3.\+11.\+0
\item Bash $>$= 3.\+2.\+57
\end{DoxyItemize}\hypertarget{md_pages_getstarted_build_tests_eigen_autotoc_md30}{}\doxysection{1. Prep}\label{md_pages_getstarted_build_tests_eigen_autotoc_md30}
...
These are needed because {\ttfamily CC} and {\ttfamily C\+XX} are used to do all the builds.\hypertarget{md_pages_getstarted_build_tests_eigen_autotoc_md31}{}\doxysection{2. Cloning}\label{md_pages_getstarted_build_tests_eigen_autotoc_md31}
...
\end{DoxyCode}
\hypertarget{md_pages_getstarted_build_tests_eigen_autotoc_md32}{}\doxysection{3. Install T\+P\+Ls}\label{md_pages_getstarted_build_tests_eigen_autotoc_md32}
...
\end{DoxyCode}
\hypertarget{md_pages_getstarted_build_tests_eigen_autotoc_md33}{}\doxysection{4. Build the tests}\label{md_pages_getstarted_build_tests_eigen_autotoc_md33}
...
\end{DoxyCode}
\hypertarget{md_pages_getstarted_build_tests_eigen_autotoc_md34}{}\doxysection{5. Running the tests}\label{md_pages_getstarted_build_tests_eigen_autotoc_md34}
