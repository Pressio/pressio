...
Public namespace\+: {\ttfamily pressio\+::ode} \hypertarget{md_pages_components_ode_advance_autotoc_md46}{}\doxysection{Scope and overview}\label{md_pages_components_ode_advance_autotoc_md46}
...
\DoxyCodeLine{                     \textcolor{keyword}{const} pressio::ode::step\_count\_type num\_steps,}
...
~\newline
\hypertarget{md_pages_components_ode_advance_autotoc_md48}{}\doxysection{Parameters and Requirements}\label{md_pages_components_ode_advance_autotoc_md48}

\begin{DoxyItemize}
\item {\ttfamily stepper}\+:
\begin{DoxyItemize}
\item the steppable object, must conform to\+: 
\begin{DoxyCode}{0}
...
\end{DoxyItemize}
\item {\ttfamily state}\+: self-\/explanatory
\item {\ttfamily start\+\_\+time}\+: self-\/explanatory
\item {\ttfamily final\+\_\+time}\+: self-\/explanatory
\item {\ttfamily num\+\_\+steps}\+: self-\/explanatory
\item {\ttfamily time\+\_\+ste\+\_\+size\+\_\+manager}\+:
\begin{DoxyItemize}
\item functor for setting the time step size 
\begin{DoxyCode}{0}
...
\begin{DoxyItemize}
\item functor to \char`\"{}observe\char`\"{} the state during the time integration, allowing you to potentially collect necessary data/metrics/statistics. Must conform to\+: 
\begin{DoxyCode}{0}
...
~\newline
\hypertarget{md_pages_components_ode_advance_autotoc_md49}{}\doxysection{When are the variadic arguments useful?}\label{md_pages_components_ode_advance_autotoc_md49}
