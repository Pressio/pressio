...
where {\ttfamily name} is one of the following enum class values\+: {\ttfamily Forward\+Euler}, {\ttfamily Runge\+Kutta4}, {\ttfamily Adams\+Bashforth2}, {\ttfamily SSPRunge\+Kutta3}. This function returns an instance of the desired stepper. The returned stepper object satisfies the \char`\"{}steppable\char`\"{} concept discussed \href{/Users/fnrizzi/Desktop/work/ROM/gitrepos/pressio/docs/html/md_pages_components_ode_advance.html}{\texttt{ here}}, so one can use the \char`\"{}advancers\char`\"{} functions to step forward.\hypertarget{md_pages_components_ode_steppers_explicit_autotoc_md52}{}\doxysection{Parameters and Requirements}\label{md_pages_components_ode_steppers_explicit_autotoc_md52}
...
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_explicit_autotoc_md53}{}\doxysection{Example usage}\label{md_pages_components_ode_steppers_explicit_autotoc_md53}
