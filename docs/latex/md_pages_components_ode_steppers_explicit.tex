...
Public namespace\+: {\ttfamily pressio\+::ode} \hypertarget{md_pages_components_ode_steppers_explicit_autotoc_md51}{}\doxysection{Overview}\label{md_pages_components_ode_steppers_explicit_autotoc_md51}
...
\begin{DoxyItemize}
\item a value of the {\ttfamily Step\+Scheme} enum
\item must be one of\+: {\ttfamily Forward\+Euler}, {\ttfamily Runge\+Kutta4}, {\ttfamily Adams\+Bashforth2}, {\ttfamily SSPRunge\+Kutta3}.
\end{DoxyItemize}
\item {\ttfamily state}\+:
\begin{DoxyItemize}
\item your state, must be copy constructible
\end{DoxyItemize}
\item {\ttfamily system}\+:
\begin{DoxyItemize}
\item problem instance to query for velocity $f$ and how to compute it.~\newline
...
The above factory function returns a stepper instance for the desired scheme. The returned stepper object satisfies the \char`\"{}steppable\char`\"{} concept discussed \href{/Users/fnrizzi/Desktop/work/ROM/gitrepos/pressio/docs/html/md_pages_components_ode_advance.html}{\texttt{ here}}, so one can use the \char`\"{}advancers\char`\"{} functions to step forward. \hypertarget{md_pages_components_ode_steppers_explicit_autotoc_md53}{}\doxysection{Example usage}\label{md_pages_components_ode_steppers_explicit_autotoc_md53}
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_explicit_autotoc_md54}{}\doxysection{Required specializations for custom types}\label{md_pages_components_ode_steppers_explicit_autotoc_md54}
