...
\DoxyCodeLine{\textcolor{keyword}{auto} create\_explicit\_stepper(pressio::ode::SteppersE name,}
...
\DoxyCodeLine{  \textcolor{keyword}{const} \textcolor{keyword}{auto} scheme = pode::SteppersE::ForwardEuler;}
