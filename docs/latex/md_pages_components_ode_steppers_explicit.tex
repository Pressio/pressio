...
Public namespace\+: {\ttfamily pressio\+::ode}\hypertarget{md_pages_components_ode_steppers_explicit_autotoc_md38}{}\doxysection{Overview}\label{md_pages_components_ode_steppers_explicit_autotoc_md38}
...
where {\ttfamily keyword} is one of\+: {\ttfamily forward\+\_\+euler}, {\ttfamily runge\+\_\+kutta4}, {\ttfamily adams\+\_\+bashforth2}, {\ttfamily ssp\+\_\+runge\+\_\+kutta3}. This function returns an instance of the desired stepper. The returned stepper object satisfies the \char`\"{}steppable\char`\"{} concept discussed \href{/Users/fnrizzi/Desktop/work/ROM/gitrepos/pressio/docs/html/md_pages_components_ode_advance.html}{\texttt{ here}}, so one can use the \char`\"{}advancers\char`\"{} functions to step forward.\hypertarget{md_pages_components_ode_steppers_explicit_autotoc_md40}{}\doxysection{Parameters}\label{md_pages_components_ode_steppers_explicit_autotoc_md40}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_explicit_autotoc_md41}{}\doxysection{Requirements}\label{md_pages_components_ode_steppers_explicit_autotoc_md41}
...
\end{DoxyItemize}\hypertarget{md_pages_components_ode_steppers_explicit_autotoc_md42}{}\doxysection{Example usage}\label{md_pages_components_ode_steppers_explicit_autotoc_md42}
...
\end{DoxyCode}
\hypertarget{md_pages_components_ode_steppers_explicit_autotoc_md43}{}\doxysection{Required specializations for custom types}\label{md_pages_components_ode_steppers_explicit_autotoc_md43}
