...
Recall from \href{md_pages_components_rom_galerkin.html}{\texttt{ this page}}, that using a pressio Galerkin problem involves three steps\+:
...
~\newline
 \DoxyHorRuler{0}
 ~\newline
\hypertarget{md_pages_components_rom_galerkin_default_autotoc_md93}{}\doxysection{1. Creating a problem instance}\label{md_pages_components_rom_galerkin_default_autotoc_md93}
