...
Public namespace\+: {\ttfamily pressio\+::rom}, {\ttfamily pressio\+::rom\+::galerkin}.\hypertarget{md_pages_components_rom_galerkin_default_autotoc_md96}{}\doxysection{Overview}\label{md_pages_components_rom_galerkin_default_autotoc_md96}
...
where {\ttfamily Stepper\+Tag} is a tag type from the ode to specify which time scheme to use. This function returns an instance of the desired Galerkin problem.\hypertarget{md_pages_components_rom_galerkin_default_autotoc_md98}{}\doxysubsection{Parameters and Requirements}\label{md_pages_components_rom_galerkin_default_autotoc_md98}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_rom_galerkin_default_autotoc_md99}{}\doxysubsection{Problem class API}\label{md_pages_components_rom_galerkin_default_autotoc_md99}
