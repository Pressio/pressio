...
Public namespace\+: {\ttfamily pressio\+::rom}, {\ttfamily pressio\+::rom\+::galerkin}.\hypertarget{md_pages_components_rom_galerkin_default_autotoc_md97}{}\doxysection{Overview}\label{md_pages_components_rom_galerkin_default_autotoc_md97}
...
where {\ttfamily Stepper\+Tag} is a tag type from the ode to specify which time scheme to use. This function returns an instance of the desired Galerkin problem.\hypertarget{md_pages_components_rom_galerkin_default_autotoc_md99}{}\doxysubsection{Parameters and Requirements}\label{md_pages_components_rom_galerkin_default_autotoc_md99}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_rom_galerkin_default_autotoc_md100}{}\doxysubsection{Problem class API}\label{md_pages_components_rom_galerkin_default_autotoc_md100}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_galerkin_default_autotoc_md101}{}\doxysection{2.,3. Extract and Solve}\label{md_pages_components_rom_galerkin_default_autotoc_md101}
\hypertarget{md_pages_components_rom_galerkin_default_autotoc_md102}{}\doxysubsection{Explicit Case}\label{md_pages_components_rom_galerkin_default_autotoc_md102}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_galerkin_default_autotoc_md103}{}\doxysubsection{Implicit Case}\label{md_pages_components_rom_galerkin_default_autotoc_md103}
