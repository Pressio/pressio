...
\end{DoxyParagraph}
\hypertarget{md_pages_coreconcepts_adapter_api_autotoc_md1}{}\doxysection{Continuous-\/time API}\label{md_pages_coreconcepts_adapter_api_autotoc_md1}
...
\end{DoxyItemize}\hypertarget{md_pages_coreconcepts_adapter_api_autotoc_md2}{}\doxysubsection{A\+: velocity only}\label{md_pages_coreconcepts_adapter_api_autotoc_md2}
...
\end{DoxyParagraph}
\hypertarget{md_pages_coreconcepts_adapter_api_autotoc_md3}{}\doxysubsection{B\+: velocity and Jacobian action}\label{md_pages_coreconcepts_adapter_api_autotoc_md3}
...
\end{DoxyParagraph}
\hypertarget{md_pages_coreconcepts_adapter_api_autotoc_md4}{}\doxysection{Discrete-\/time API}\label{md_pages_coreconcepts_adapter_api_autotoc_md4}
