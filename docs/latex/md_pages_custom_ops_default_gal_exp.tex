This page explains which operations you need to provide to pressio to construct and run Galerkin with explicit time stepping when you are using F\+OM types that are {\itshape not} natively supported in pressio.
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_pages_custom_ops_default_gal_exp_autotoc_md14}{}\doxysection{Where does one need to use this?}\label{md_pages_custom_ops_default_gal_exp_autotoc_md14}
