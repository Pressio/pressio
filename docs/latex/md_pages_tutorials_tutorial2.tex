...
\DoxyCodeLine{  \textcolor{comment}{// create a native phi with and fill with ones}}
...
\DoxyCodeLine{  \textcolor{comment}{// and an object that knows how to compute the operations (see next section)}}
