...
\end{DoxyParagraph}
\hypertarget{md_pages_tutorials_tutorial2_autotoc_md56}{}\doxysection{What is a default Galerkin problem?}\label{md_pages_tutorials_tutorial2_autotoc_md56}
...
\end{DoxyParagraph}
where $\hat{y}$ is the reduced state, also called generalized coordinates, $y$ is the full-\/order model (F\+OM) state, $y_{ref}$ is a reference F\+OM state, $\phi$ is the orthonormal basis, and $f(...)$ is the F\+OM velocity. Schematically, this system corresponds to the figure below. \hypertarget{md_pages_tutorials_tutorial2_autotoc_md57}{}\doxysection{How to create a default Galerkin problem?}\label{md_pages_tutorials_tutorial2_autotoc_md57}
