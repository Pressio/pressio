...
\item \mbox{[}optional\mbox{]} an object with specific kernels when the F\+OM types are not natively supported by pressio. See \href{./md_pages_custom_ops_default_gal_exp.html}{\texttt{ this page}} for more information on this.
\end{DoxyEnumerate}
