...
\end{DoxyParagraph}
\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md192}{}\doxysection{Prerequisites}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md192}

\begin{DoxyItemize}
\item C and C++11 compilers\+: either Clang or GNU
\item CMake $>$= 3.\+11.\+0
\item Bash $>$= 3.\+2.\+57
\end{DoxyItemize}\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md193}{}\doxysection{1. Prep}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md193}
...
These are needed because {\ttfamily CC} and {\ttfamily CXX} are used to do all the builds.\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md194}{}\doxysection{2. Cloning}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md194}
...
\end{DoxyCode}
\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md195}{}\doxysection{3. Install TPLs}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md195}
...
\end{DoxyCode}
\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md196}{}\doxysection{4. Build the tests}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md196}
...
\end{DoxyCode}
\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md197}{}\doxysection{5. Running the tests}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md197}
