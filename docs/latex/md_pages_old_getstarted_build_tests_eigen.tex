...
\end{DoxyParagraph}
\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md163}{}\doxysection{Prerequisites}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md163}

\begin{DoxyItemize}
\item C and C++11 compilers\+: either Clang or GNU
\item CMake $>$= 3.\+11.\+0
\item Bash $>$= 3.\+2.\+57
\end{DoxyItemize}\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md164}{}\doxysection{1. Prep}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md164}
...
These are needed because {\ttfamily CC} and {\ttfamily CXX} are used to do all the builds.\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md165}{}\doxysection{2. Cloning}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md165}
...
\end{DoxyCode}
\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md166}{}\doxysection{3. Install TPLs}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md166}
...
\end{DoxyCode}
\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md167}{}\doxysection{4. Build the tests}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md167}
...
\end{DoxyCode}
\hypertarget{md_pages_old_getstarted_build_tests_eigen_autotoc_md168}{}\doxysection{5. Running the tests}\label{md_pages_old_getstarted_build_tests_eigen_autotoc_md168}
