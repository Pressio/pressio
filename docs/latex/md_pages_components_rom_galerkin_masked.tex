...
Public namespace\+: {\ttfamily pressio\+::rom}, {\ttfamily pressio\+::rom\+::galerkin}.\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md111}{}\doxysection{1. Creating a problem instance}\label{md_pages_components_rom_galerkin_masked_autotoc_md111}
...
where {\ttfamily Stepper\+Tag} is a tag type from the ode to specify which time scheme to use. This function returns an instance of the desired Galerkin problem.\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md112}{}\doxysubsection{Parameters and Requirements}\label{md_pages_components_rom_galerkin_masked_autotoc_md112}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md113}{}\doxysubsection{Masker}\label{md_pages_components_rom_galerkin_masked_autotoc_md113}
todo\+: explain
