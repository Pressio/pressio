...
\end{DoxyParagraph}
\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md104}{}\doxysection{API}\label{md_pages_components_rom_galerkin_masked_autotoc_md104}
...
This function returns an instance of the desired Galerkin problem.\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md105}{}\doxysubsection{Parameters and Requirements}\label{md_pages_components_rom_galerkin_masked_autotoc_md105}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md106}{}\doxysection{Masker}\label{md_pages_components_rom_galerkin_masked_autotoc_md106}
todo\+: explain
