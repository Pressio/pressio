...
Public namespace\+: {\ttfamily pressio\+::rom}, {\ttfamily pressio\+::rom\+::galerkin}.\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md113}{}\doxysection{1. Creating a problem instance}\label{md_pages_components_rom_galerkin_masked_autotoc_md113}
...
where {\ttfamily Stepper\+Tag} is a tag type from the ode to specify which time scheme to use. This function returns an instance of the desired Galerkin problem.\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md114}{}\doxysubsection{Parameters and Requirements}\label{md_pages_components_rom_galerkin_masked_autotoc_md114}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_rom_galerkin_masked_autotoc_md115}{}\doxysubsection{Masker}\label{md_pages_components_rom_galerkin_masked_autotoc_md115}
todo\+: explain
