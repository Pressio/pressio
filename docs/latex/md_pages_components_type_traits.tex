...
Public namespace\+: {\ttfamily pressio} \hypertarget{md_pages_components_type_traits_autotoc_md147}{}\doxysection{Overview}\label{md_pages_components_type_traits_autotoc_md147}
...
~\newline
\hypertarget{md_pages_components_type_traits_autotoc_md148}{}\doxysection{Traits class}\label{md_pages_components_type_traits_autotoc_md148}
todo\+: finish
...
~\newline
\hypertarget{md_pages_components_type_traits_autotoc_md149}{}\doxysection{Type detection and identification}\label{md_pages_components_type_traits_autotoc_md149}
...
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+static\+\_\+vector\+\_\+eigen;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a static Eigen vector. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+EIGEN==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+dynamic\+\_\+vector\+\_\+eigen;}   &Static member constant {\ttfamily value} is true ~\newline
...
{\ttfamily template$<$class T$>$} ~\newline
 ...
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+EIGEN==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+sparse\+\_\+matrix\+\_\+eigen;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a static or dynamic sparse Eigen matrix. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+EIGEN==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+static\+\_\+dense\+\_\+matrix\+\_\+eigen;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a static dense Eigen matrix. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+EIGEN==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+dynamic\+\_\+dense\+\_\+matrix\+\_\+eigen;}   &Static member constant {\ttfamily value} is true ~\newline
...
{\ttfamily template$<$class T$>$} ~\newline
 ...
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+EIGEN==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+dense\+\_\+vector\+\_\+teuchos;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a dense Teuchos vector. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+TRILINOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+dense\+\_\+matrix\+\_\+teuchos;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a dense Teuchos matrix. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+TRILINOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+vector\+\_\+epetra;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is Epetra vector. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+TRILINOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+multi\+\_\+vector\+\_\+epetra;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is an Epetra multi vector. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+TRILINOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+vector\+\_\+tpetra;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a Tpetra vector. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+TRILINOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+multi\+\_\+vector\+\_\+tpetra;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a Tpetra multi vector. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+TRILINOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+vector\+\_\+tpetra\+\_\+block;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a Tpetra-\/block vector. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+TRILINOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+multi\+\_\+vector\+\_\+tpetra\+\_\+block;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a Tpetra-\/block multi vector. ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+TRILINOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+static\+\_\+vector\+\_\+kokkos;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a static Kokkos vector (rank-\/1 View). ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+KOKKOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+dynamic\+\_\+vector\+\_\+kokkos;}   &Static member constant {\ttfamily value} is true ~\newline
...
{\ttfamily template$<$class T$>$} ~\newline
 ...
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+KOKKOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+static\+\_\+dense\+\_\+matrix\+\_\+kokkos;}   &Static member constant {\ttfamily value} is true ~\newline
 if {\ttfamily T} is a static dense Kokkos matrix (rank-\/2 View). ~\newline
 Requires\+: {\ttfamily PRESSIO\+\_\+\+ENABLE\+\_\+\+TPL\+\_\+\+KOKKOS==On}    \\\cline{1-2}
{\ttfamily template$<$class T$>$} ~\newline
 {\ttfamily struct is\+\_\+dynamic\+\_\+dense\+\_\+matrix\+\_\+kokkos;}   &Static member constant {\ttfamily value} is true ~\newline
