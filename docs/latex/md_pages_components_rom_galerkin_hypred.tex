...
Public namespace\+: {\ttfamily pressio\+::rom}, {\ttfamily pressio\+::rom\+::galerkin}.\hypertarget{md_pages_components_rom_galerkin_hypred_autotoc_md106}{}\doxysection{Overview}\label{md_pages_components_rom_galerkin_hypred_autotoc_md106}
...
where {\ttfamily Stepper\+Tag} is a tag type from the ode to specify which time scheme to use. This function returns an instance of the desired Galerkin problem.\hypertarget{md_pages_components_rom_galerkin_hypred_autotoc_md108}{}\doxysubsection{Parameters and Requirements}\label{md_pages_components_rom_galerkin_hypred_autotoc_md108}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_rom_galerkin_hypred_autotoc_md109}{}\doxysubsection{Problem class API}\label{md_pages_components_rom_galerkin_hypred_autotoc_md109}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_galerkin_hypred_autotoc_md110}{}\doxysubsection{Projector}\label{md_pages_components_rom_galerkin_hypred_autotoc_md110}
