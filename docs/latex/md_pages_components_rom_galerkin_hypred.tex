...
\end{DoxyParagraph}
\hypertarget{md_pages_components_rom_galerkin_hypred_autotoc_md100}{}\doxysection{API}\label{md_pages_components_rom_galerkin_hypred_autotoc_md100}
...
\end{DoxyCode}
 This function returns an instance of the desired Galerkin problem.\hypertarget{md_pages_components_rom_galerkin_hypred_autotoc_md101}{}\doxysubsection{Parameters and Requirements}\label{md_pages_components_rom_galerkin_hypred_autotoc_md101}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_rom_galerkin_hypred_autotoc_md102}{}\doxysection{Projector}\label{md_pages_components_rom_galerkin_hypred_autotoc_md102}
