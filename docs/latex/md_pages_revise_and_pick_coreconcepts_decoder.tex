...
where $y_{rom}$ is the reduced state (or generalized coordinates), and $g$ is the mapping between the two.\hypertarget{md_pages_revise_and_pick_coreconcepts_decoder_autotoc_md169}{}\doxysection{Linear}\label{md_pages_revise_and_pick_coreconcepts_decoder_autotoc_md169}
...
\end{DoxyCode}
\hypertarget{md_pages_revise_and_pick_coreconcepts_decoder_autotoc_md170}{}\doxysection{Generic decoder API}\label{md_pages_revise_and_pick_coreconcepts_decoder_autotoc_md170}
