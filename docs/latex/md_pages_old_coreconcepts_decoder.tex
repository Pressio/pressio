...
where $y_{rom}$ is the reduced state (or generalized coordinates), and $g$ is the mapping between the two.\hypertarget{md_pages_old_coreconcepts_decoder_autotoc_md72}{}\doxysection{Linear}\label{md_pages_old_coreconcepts_decoder_autotoc_md72}
...
\end{DoxyCode}
\hypertarget{md_pages_old_coreconcepts_decoder_autotoc_md73}{}\doxysection{Generic decoder API}\label{md_pages_old_coreconcepts_decoder_autotoc_md73}
