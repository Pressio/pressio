...
where $y_{rom}$ is the reduced state (or generalized coordinates), and $g$ is the mapping between the two.\hypertarget{md_pages_old_coreconcepts_decoder_autotoc_md108}{}\doxysection{Linear}\label{md_pages_old_coreconcepts_decoder_autotoc_md108}
...
\end{DoxyCode}
\hypertarget{md_pages_old_coreconcepts_decoder_autotoc_md109}{}\doxysection{Generic decoder API}\label{md_pages_old_coreconcepts_decoder_autotoc_md109}
