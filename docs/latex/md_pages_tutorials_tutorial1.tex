...
For other types (e.\+g., Trilinos) already known to pressio (which means pressio knows how to operate on), it would work similarly. If you work with an arbitrary type (i.\+e. one for which pressio does not know how to operate on), see \mbox{[}this tutorial\mbox{]}(). 