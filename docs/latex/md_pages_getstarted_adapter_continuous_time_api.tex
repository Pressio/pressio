...
\end{DoxyItemize}\hypertarget{md_pages_getstarted_adapter_continuous_time_api_autotoc_md17}{}\doxysection{A\+: velocity only}\label{md_pages_getstarted_adapter_continuous_time_api_autotoc_md17}
...
\end{DoxyParagraph}
\hypertarget{md_pages_getstarted_adapter_continuous_time_api_autotoc_md18}{}\doxysection{B\+: velocity and Jacobian action}\label{md_pages_getstarted_adapter_continuous_time_api_autotoc_md18}
