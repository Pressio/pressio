...
Public namespace\+: {\ttfamily pressio\+::nonlinearsolvers} \hypertarget{md_pages_components_nonlinsolvers_general_autotoc_md12}{}\doxysection{Overview}\label{md_pages_components_nonlinsolvers_general_autotoc_md12}
...
Iteratively reweighted least squares (irls)   &\href{./md_pages_components_nonlinsolvers_irls.html}{\texttt{ Link}}   &optimization problem formulated in a p-\/norm (see \href{https://en.wikipedia.org/wiki/Iteratively_reweighted_least_squares}{\texttt{ link}} )   \\\cline{1-3}
\end{longtabu}


~\newline
\hypertarget{md_pages_components_nonlinsolvers_general_autotoc_md13}{}\doxysubsection{A glimpse of the API}\label{md_pages_components_nonlinsolvers_general_autotoc_md13}
...
Please refer to each method\textquotesingle{}s documentation for the details on the API and arguments.

~\newline
\hypertarget{md_pages_components_nonlinsolvers_general_autotoc_md14}{}\doxysection{What are you responsible of?}\label{md_pages_components_nonlinsolvers_general_autotoc_md14}
If you want to use the pressio nonlinear solvers, you are responsible of\+:


\begin{DoxyItemize}
\item A\+: providing a problem object
\item B\+: selecting (if needed) the convergence criterion
\item C\+: selecting (if needed) the update method
\end{DoxyItemize}\hypertarget{md_pages_components_nonlinsolvers_general_autotoc_md15}{}\doxysubsection{A\+: problem class}\label{md_pages_components_nonlinsolvers_general_autotoc_md15}
...
Gauss-\/\+Newton via Normal-\/\+Equations   &admissible   &admissible   &admissible   &admissible    \\\cline{1-5}
Gauss-\/\+Newton via QR   &admissible   &admissible   &-\/   &-\/    \\\cline{1-5}
Levenberg-\/\+Marquardt   &admissible   &admissible   &admissible   &admissible    \\\cline{1-5}
irls   &admissible   &admissible   &-\/   &-\/   \\\cline{1-5}
\end{longtabu}


Please refer to each method\textquotesingle{}s documentation for the details on how you provide a problem instance to pressio.\hypertarget{md_pages_components_nonlinsolvers_general_autotoc_md16}{}\doxysubsection{B\+: Convergence and tolerance}\label{md_pages_components_nonlinsolvers_general_autotoc_md16}
...
\end{DoxyCode}
\hypertarget{md_pages_components_nonlinsolvers_general_autotoc_md17}{}\doxysubsection{C\+: Setting the update}\label{md_pages_components_nonlinsolvers_general_autotoc_md17}
...
\end{DoxyItemize}
\end{DoxyParagraph}
\hypertarget{md_pages_components_nonlinsolvers_general_autotoc_md18}{}\doxysection{A note on the solvers\textquotesingle{} design}\label{md_pages_components_nonlinsolvers_general_autotoc_md18}
