...
Public namespace\+: {\ttfamily pressio\+::rom}\hypertarget{md_pages_components_rom_decoder_linear_autotoc_md79}{}\doxysection{Overview}\label{md_pages_components_rom_decoder_linear_autotoc_md79}
...
The returned linear decoder object meets the \href{./md_pages_components_rom_decoder.html}{\texttt{ decoder concept}}.\hypertarget{md_pages_components_rom_decoder_linear_autotoc_md80}{}\doxysubsection{Parameters}\label{md_pages_components_rom_decoder_linear_autotoc_md80}

\begin{DoxyItemize}
\item {\ttfamily Fom\+State\+Type}\+: data type of your FOM state
\item {\ttfamily Jacobian\+Matrix\+Type}\+: data type your Jacobian matrix
\end{DoxyItemize}\hypertarget{md_pages_components_rom_decoder_linear_autotoc_md81}{}\doxysubsection{Requirements}\label{md_pages_components_rom_decoder_linear_autotoc_md81}
...
\end{DoxyItemize}\hypertarget{md_pages_components_rom_decoder_linear_autotoc_md82}{}\doxysection{Example usage for supported types}\label{md_pages_components_rom_decoder_linear_autotoc_md82}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_decoder_linear_autotoc_md83}{}\doxysection{Example usage for custom types}\label{md_pages_components_rom_decoder_linear_autotoc_md83}
