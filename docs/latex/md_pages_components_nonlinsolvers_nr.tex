...
Public namespace\+: {\ttfamily pressio\+::nonlinearsolvers} \hypertarget{md_pages_components_nonlinsolvers_nr_autotoc_md38}{}\doxysection{Newton-\/\+Raphson}\label{md_pages_components_nonlinsolvers_nr_autotoc_md38}
\hypertarget{md_pages_components_nonlinsolvers_nr_autotoc_md39}{}\doxysubsection{API, Parameters and Requirements}\label{md_pages_components_nonlinsolvers_nr_autotoc_md39}
...
\begin{DoxyItemize}
\item linear solver called at each inner iteration
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_pages_components_nonlinsolvers_nr_autotoc_md40}{}\doxysubsection{Ops}\label{md_pages_components_nonlinsolvers_nr_autotoc_md40}
...
\end{DoxyCode}
\hypertarget{md_pages_components_nonlinsolvers_nr_autotoc_md41}{}\doxysubsection{Example usage}\label{md_pages_components_nonlinsolvers_nr_autotoc_md41}
