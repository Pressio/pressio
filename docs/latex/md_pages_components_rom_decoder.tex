\hypertarget{md_pages_components_rom_decoder_autotoc_md70}{}\doxysection{Overview}\label{md_pages_components_rom_decoder_autotoc_md70}
...
Note that there is no explicit constraint on what the mapping is, it can be anything.\hypertarget{md_pages_components_rom_decoder_autotoc_md71}{}\doxysection{Decoder Concept}\label{md_pages_components_rom_decoder_autotoc_md71}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_decoder_autotoc_md72}{}\doxysubsection{Requirements}\label{md_pages_components_rom_decoder_autotoc_md72}
...
~\newline
\hypertarget{md_pages_components_rom_decoder_autotoc_md73}{}\doxysection{Special case\+: linear decoder}\label{md_pages_components_rom_decoder_autotoc_md73}
...
Obviously, the returned linear decoder object meets the decoder concept discussed above.\hypertarget{md_pages_components_rom_decoder_autotoc_md74}{}\doxysubsection{Example usage for supported types}\label{md_pages_components_rom_decoder_autotoc_md74}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_decoder_autotoc_md75}{}\doxysubsection{Example usage for custom types}\label{md_pages_components_rom_decoder_autotoc_md75}
