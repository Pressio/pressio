...
~\newline
\hypertarget{md_pages_components_rom_decoder_autotoc_md70}{}\doxysection{Decoder Concept}\label{md_pages_components_rom_decoder_autotoc_md70}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_decoder_autotoc_md71}{}\doxysubsection{Requirements}\label{md_pages_components_rom_decoder_autotoc_md71}
...
~\newline
 \DoxyHorRuler{0}
 ~\newline
\hypertarget{md_pages_components_rom_decoder_autotoc_md72}{}\doxysection{Special case\+: linear decoder}\label{md_pages_components_rom_decoder_autotoc_md72}
...
~\newline
\hypertarget{md_pages_components_rom_decoder_autotoc_md73}{}\doxysubsection{Example usage for supported types}\label{md_pages_components_rom_decoder_autotoc_md73}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_decoder_autotoc_md74}{}\doxysubsection{Example usage for custom types}\label{md_pages_components_rom_decoder_autotoc_md74}
