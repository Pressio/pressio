\hypertarget{md_pages_components_rom_decoder_autotoc_md75}{}\doxysection{Overview}\label{md_pages_components_rom_decoder_autotoc_md75}
...
Note that there is no explicit constraint on what the mapping is, it can be anything.\hypertarget{md_pages_components_rom_decoder_autotoc_md76}{}\doxysection{Decoder Concept}\label{md_pages_components_rom_decoder_autotoc_md76}
...
\end{DoxyCode}
\hypertarget{md_pages_components_rom_decoder_autotoc_md77}{}\doxysubsection{Requirements}\label{md_pages_components_rom_decoder_autotoc_md77}

\begin{DoxyItemize}
\item {\ttfamily fom\+\_\+state\+\_\+type}\+: must be copy constructible
\item {\ttfamily jacobian\+\_\+type}\+: must be copy constructible
\end{DoxyItemize}\hypertarget{md_pages_components_rom_decoder_autotoc_md78}{}\doxysubsection{Special case\+: linear decoder}\label{md_pages_components_rom_decoder_autotoc_md78}
