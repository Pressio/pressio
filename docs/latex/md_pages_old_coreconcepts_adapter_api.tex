...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md75}{}\doxysection{Continuous-\/time API}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md75}
...
\end{DoxyItemize}\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md76}{}\doxysubsection{A\+: velocity only}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md76}
...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md77}{}\doxysubsection{B\+: velocity and Jacobian action}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md77}
...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md78}{}\doxysection{Discrete-\/time API}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md78}
