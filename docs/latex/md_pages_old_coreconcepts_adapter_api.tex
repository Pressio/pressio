...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md67}{}\doxysection{Continuous-\/time API}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md67}
...
\end{DoxyItemize}\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md68}{}\doxysubsection{A\+: velocity only}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md68}
...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md69}{}\doxysubsection{B\+: velocity and Jacobian action}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md69}
...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md70}{}\doxysection{Discrete-\/time API}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md70}
