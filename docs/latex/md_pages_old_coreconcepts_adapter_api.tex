...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md66}{}\doxysection{Continuous-\/time API}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md66}
...
\end{DoxyItemize}\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md67}{}\doxysubsection{A\+: velocity only}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md67}
...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md68}{}\doxysubsection{B\+: velocity and Jacobian action}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md68}
...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md69}{}\doxysection{Discrete-\/time API}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md69}
