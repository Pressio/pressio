...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md83}{}\doxysection{Continuous-\/time API}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md83}
...
\end{DoxyItemize}\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md84}{}\doxysubsection{A\+: velocity only}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md84}
...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md85}{}\doxysubsection{B\+: velocity and Jacobian action}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md85}
...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md86}{}\doxysection{Discrete-\/time API}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md86}
