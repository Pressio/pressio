...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md90}{}\doxysection{Continuous-\/time API}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md90}
...
\end{DoxyItemize}\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md91}{}\doxysubsection{A\+: velocity only}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md91}
...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md92}{}\doxysubsection{B\+: velocity and Jacobian action}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md92}
...
\end{DoxyParagraph}
\hypertarget{md_pages_old_coreconcepts_adapter_api_autotoc_md93}{}\doxysection{Discrete-\/time API}\label{md_pages_old_coreconcepts_adapter_api_autotoc_md93}
