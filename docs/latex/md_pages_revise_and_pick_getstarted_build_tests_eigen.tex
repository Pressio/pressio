...
\end{DoxyParagraph}
\hypertarget{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md180}{}\doxysection{Prerequisites}\label{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md180}

\begin{DoxyItemize}
\item C and C++11 compilers\+: either Clang or GNU
\item CMake $>$= 3.\+11.\+0
\item Bash $>$= 3.\+2.\+57
\end{DoxyItemize}\hypertarget{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md181}{}\doxysection{1. Prep}\label{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md181}
...
These are needed because {\ttfamily CC} and {\ttfamily CXX} are used to do all the builds.\hypertarget{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md182}{}\doxysection{2. Cloning}\label{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md182}
...
\end{DoxyCode}
\hypertarget{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md183}{}\doxysection{3. Install TPLs}\label{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md183}
...
\end{DoxyCode}
\hypertarget{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md184}{}\doxysection{4. Build the tests}\label{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md184}
...
\end{DoxyCode}
\hypertarget{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md185}{}\doxysection{5. Running the tests}\label{md_pages_revise_and_pick_getstarted_build_tests_eigen_autotoc_md185}
